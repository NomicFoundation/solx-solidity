...
// CHECK-NEXT:       call @f_24(%14, %19, %23) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:       "llvm.intrcall"(%26, %c0_i256) <{id = 4078 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
// CHECK-NEXT:       call @".unreachable"() : () -> () loc(#loc1)
...
// CHECK-NEXT:       %6 = arith.andi %3, %c1461501637330902918203684832716283019655932542975_i256 : i256 loc(#loc9)
// CHECK-NEXT:       %7 = arith.andi %4, %c1461501637330902918203684832716283019655932542975_i256 : i256 loc(#loc9)
...
// CHECK-NEXT:       %10 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       llvm.store %5, %10 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       %11 = llvm.inttoptr %9 : i256 to !llvm.ptr<1> loc(#loc9)
// CHECK-NEXT:       "llvm.intrcall"(%11, %c32_i256, %c-8221849663638083512194660606707573152552498519683245605175914703537671859757_i256, %6, %7) <{id = 4064 : i32, name = "evm.log3"}> : (!llvm.ptr<1>, i256, i256, i256, i256) -> () loc(#loc9)
