...
// CHECK-NEXT:       cf.br ^bb4 loc(#loc1)
// CHECK-NEXT:     ^bb4:  // 2 preds: ^bb2, ^bb3
// CHECK-NEXT:       call @del_12() : () -> () loc(#loc1)
...
// CHECK-NEXT:       llvm.unreachable loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     func.func @del_12() attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
// CHECK-NEXT:       %c0_i256 = arith.constant 0 : i256 loc(#loc)
...
// CHECK-NEXT:       %1 = arith.cmpi ult, %0, %c100_i256 : i256 loc(#loc3)
// CHECK-NEXT:       cf.cond_br %1, ^bb2(%0 : i256), ^bb3 loc(#loc3)
// CHECK-NEXT:     ^bb2(%2: i256 loc({{.*}}:13:8)):  // pred: ^bb1
// CHECK-NEXT:       %3 = llvm.inttoptr %2 : i256 to !llvm.ptr<5> loc(#loc3)
// CHECK-NEXT:       llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc3)
// CHECK-NEXT:       %4 = arith.addi %2, %c1_i256 : i256 loc(#loc3)
// CHECK-NEXT:       cf.br ^bb1(%4 : i256) loc(#loc3)
