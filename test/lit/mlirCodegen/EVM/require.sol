...
// CHECK-NEXT:     %c31858788171200504151793243853063220343653306658425181981798228421623473504256_i256 = arith.constant 31858788171200504151793243853063220343653306658425181981798228421623473504256 : i256 loc(#loc3)
...
// CHECK-NEXT:     %c3963877391197344453575983046348115674221700746820753546331534351508065746944_i256 = arith.constant 3963877391197344453575983046348115674221700746820753546331534351508065746944 : i256 loc(#loc3)
...
// CHECK-NEXT:     %2 = arith.cmpi ugt, %1, %c42_i256 : i256 loc(#loc6)
...
// CHECK-NEXT:     %5 = arith.cmpi ugt, %4, %c42_i256 : i256 loc(#loc7)
// CHECK-NEXT:     %6 = arith.cmpi eq, %5, %false : i1 loc(#loc3)
// CHECK-NEXT:     scf.if %6 {
// CHECK-NEXT:       %7 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       %8 = llvm.load %7 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc3)
// CHECK-NEXT:       %9 = llvm.inttoptr %8 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       llvm.store %c3963877391197344453575983046348115674221700746820753546331534351508065746944_i256, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       %10 = arith.addi %8, %c4_i256 : i256 loc(#loc3)
// CHECK-NEXT:       %11 = llvm.inttoptr %10 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       llvm.store %c32_i256, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       %12 = arith.addi %8, %c36_i256 : i256 loc(#loc3)
// CHECK-NEXT:       %13 = llvm.inttoptr %12 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:       llvm.store %c6_i256, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
...
// CHECK-NEXT:       "llvm.intrcall"(%16, %c100_i256) <{id = 3257 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc3)
...
// CHECK-NEXT: #loc6 = loc({{.*}}:3:10)
// CHECK-NEXT: #loc7 = loc({{.*}}:4:10)
// CHECK-EMPTY:
