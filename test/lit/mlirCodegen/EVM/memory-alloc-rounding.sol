...
// CHECK-NEXT:       %2 = arith.addi %1, %c31_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %3 = arith.andi %2, %c-32_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %4 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:       %5 = llvm.load %4 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc5)
// CHECK-NEXT:       %6 = arith.addi %3, %c63_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %7 = arith.andi %6, %c-32_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %8 = arith.addi %5, %7 : i256 loc(#loc5)
// CHECK-NEXT:       %9 = arith.cmpi ugt, %8, %c18446744073709551615_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %10 = arith.cmpi ult, %8, %5 : i256 loc(#loc5)
...
// CHECK-NEXT:       llvm.store %c65_i256, %13 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc5)
...
// CHECK-NEXT:       llvm.store %8, %15 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:       %16 = llvm.inttoptr %5 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:       llvm.store %1, %16 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:       %17 = arith.addi %5, %c32_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %18 = "llvm.intrcall"() <{id = 4038 : i32, name = "evm.calldatasize"}> : () -> i256 loc(#loc5)
// CHECK-NEXT:       %19 = llvm.inttoptr %17 : i256 to !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:       %20 = llvm.inttoptr %18 : i256 to !llvm.ptr<2> loc(#loc5)
// CHECK-NEXT:       "llvm.intr.memcpy"(%19, %20, %3) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<2>, i256) -> () loc(#loc5)
// CHECK-NEXT:       return %5 : i256 loc(#loc6)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:   } loc(#loc1)
// CHECK-NEXT: } loc(#loc)
