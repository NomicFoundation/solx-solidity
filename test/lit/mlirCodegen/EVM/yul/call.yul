...
// CHECK-NEXT:     %0 = llvm.inttoptr %c3_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %1 = llvm.inttoptr %c5_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %2 = "llvm.intrcall"(%c0_i256, %c1_i256, %c2_i256, %0, %c4_i256, %1, %c6_i256) <{id = 3692 : i32, name = "evm.call"}> : (i256, i256, i256, !llvm.ptr<1>, i256, !llvm.ptr<1>, i256) -> i256 loc(#loc2)
// CHECK-NEXT:     %3 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr loc(#loc3)
// CHECK-NEXT:     llvm.store %2, %3 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc4)
// CHECK-NEXT:     %4 = llvm.inttoptr %c2_i256 : i256 to !llvm.ptr<1> loc(#loc5)
