...
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256, %0 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc2)
// CHECK-NEXT:     cf.br ^bb1 loc(#loc3)
// CHECK-NEXT:   ^bb1:  // 2 preds: ^bb0, ^bb3
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc4)
// CHECK-NEXT:     %2 = arith.cmpi ult, %1, %c2_i256 : i256 loc(#loc5)
// CHECK-NEXT:     cf.cond_br %2, ^bb2, ^bb4 loc(#loc5)
...
// CHECK-NEXT:     %5 = arith.addi %4, %c1_i256 : i256 loc(#loc9)
// CHECK-NEXT:     llvm.store %5, %0 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc10)
// CHECK-NEXT:     cf.br ^bb1 loc(#loc3)
