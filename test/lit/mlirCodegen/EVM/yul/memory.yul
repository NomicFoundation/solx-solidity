...
// CHECK-NEXT:     %6 = "llvm.intrcall"(%c0_i256, %c255_i256) <{id = 3691 : i32, name = "evm.byte"}> : (i256, i256) -> i256 loc(#loc5)
// CHECK-NEXT:     %7 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:     "llvm.intrcall"(%7, %6) <{id = 3729 : i32, name = "evm.mstore8"}> : (!llvm.ptr<1>, i256) -> () loc(#loc6)
