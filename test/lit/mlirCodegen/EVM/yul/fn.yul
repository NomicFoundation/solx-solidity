...
// CHECK-NEXT:     llvm.store %c42_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc13)
...
// CHECK-NEXT:     %c43_i256 = arith.constant 43 : i256 loc(#loc15)
// CHECK-NEXT:     %c42_i256 = arith.constant 42 : i256 loc(#loc16)
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc14)
// CHECK-NEXT:     %0 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc17)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:     llvm.store %c42_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc19)
// CHECK-NEXT:     llvm.store %c43_i256, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc20)
...
// CHECK-NEXT:     return %2, %3 : i256, i256 loc(#loc14)
...
// CHECK-NEXT: #loc12 = loc({{.*}}:6:22)
// CHECK-NEXT: #loc13 = loc({{.*}}:7:6)
// CHECK-NEXT: #loc14 = loc({{.*}}:10:4)
// CHECK-NEXT: #loc15 = loc({{.*}}:12:11)
// CHECK-NEXT: #loc16 = loc({{.*}}:11:11)
// CHECK-NEXT: #loc17 = loc({{.*}}:10:23)
// CHECK-NEXT: #loc18 = loc({{.*}}:10:26)
// CHECK-NEXT: #loc19 = loc({{.*}}:11:6)
// CHECK-NEXT: #loc20 = loc({{.*}}:12:6)
// CHECK-EMPTY:
