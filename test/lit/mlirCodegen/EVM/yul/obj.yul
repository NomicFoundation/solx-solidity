...
// CHECK-NEXT:     "llvm.intrcall"(%0, %c11_i256) <{id = 4078 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
...
// CHECK-NEXT:       "llvm.intrcall"(%0, %c21_i256) <{id = 4078 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc4)
