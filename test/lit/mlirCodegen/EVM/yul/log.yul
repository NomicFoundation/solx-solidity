...
// CHECK-NEXT:     "llvm.intrcall"(%0, %c5_i256) <{id = 3235 : i32, name = "evm.log0"}> : (!llvm.ptr<1>, i256) -> () loc(#loc3)
...
// CHECK-NEXT:     "llvm.intrcall"(%1, %c5_i256_1, %c10_i256) <{id = 3236 : i32, name = "evm.log1"}> : (!llvm.ptr<1>, i256, i256) -> () loc(#loc7)
...
// CHECK-NEXT:     "llvm.intrcall"(%2, %c5_i256_3, %c10_i256_4, %c11_i256) <{id = 3237 : i32, name = "evm.log2"}> : (!llvm.ptr<1>, i256, i256, i256) -> () loc(#loc12)
...
// CHECK-NEXT:     "llvm.intrcall"(%3, %c5_i256_6, %c10_i256_7, %c11_i256_8, %c12_i256) <{id = 3238 : i32, name = "evm.log3"}> : (!llvm.ptr<1>, i256, i256, i256, i256) -> () loc(#loc18)
...
// CHECK-NEXT:     "llvm.intrcall"(%4, %c5_i256_10, %c10_i256_11, %c11_i256_12, %c12_i256_13, %c13_i256) <{id = 3239 : i32, name = "evm.log4"}> : (!llvm.ptr<1>, i256, i256, i256, i256, i256) -> () loc(#loc25)
