...
// CHECK-NEXT:     %1 = "llvm.intrcall"(%0, %c64_i256) <{id = 3261 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc4)
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc5)
