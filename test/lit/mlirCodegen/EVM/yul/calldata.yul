...
// CHECK-NEXT:     %2 = "llvm.intrcall"() <{id = 3214 : i32, name = "evm.calldatasize"}> : () -> i256 loc(#loc3)
// CHECK-NEXT:     %3 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:     %4 = llvm.inttoptr %1 : i256 to !llvm.ptr<2> loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%3, %4, %2) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<2>, i256) -> () loc(#loc4)
