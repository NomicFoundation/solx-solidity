...
// CHECK-NEXT:     %1 = "llvm.intrcall"(%c1_i256, %0, %c3_i256) <{id = 3701 : i32, name = "evm.create"}> : (i256, !llvm.ptr<1>, i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:     %4 = "llvm.intrcall"(%c1_i256, %3, %c3_i256, %c4_i256) <{id = 3702 : i32, name = "evm.create2"}> : (i256, !llvm.ptr<1>, i256, i256) -> i256 loc(#loc4)
