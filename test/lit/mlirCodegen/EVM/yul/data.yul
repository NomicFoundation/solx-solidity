...
// CHECK-NEXT:     %0 = "llvm.intrcall"() <{id = 3218 : i32, name = "evm.codesize"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:     %1 = "llvm.intrcall"() <{id = 3222 : i32, metadata = ["Test_deployed"], name = "evm.dataoffset"}> : () -> i256 loc(#loc2)
// CHECK-NEXT:     %2 = "llvm.intrcall"() <{id = 3223 : i32, metadata = ["Test_deployed"], name = "evm.datasize"}> : () -> i256 loc(#loc3)
