...
// CHECK-NEXT:     %5 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %6 = "llvm.intrcall"(%c0_i256) <{id = 3230 : i32, name = "evm.extcodesize"}> : (i256) -> i256 loc(#loc8)
// CHECK-NEXT:     llvm.store %6, %5 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc2)
