...
// CHECK-NEXT:     %5 = "llvm.intrcall"(%c0_i256) <{id = 3710 : i32, name = "evm.extcodehash"}> : (i256) -> i256 loc(#loc5)
// CHECK-NEXT:     %6 = "llvm.intrcall"(%c0_i256) <{id = 3711 : i32, name = "evm.extcodesize"}> : (i256) -> i256 loc(#loc6)
// CHECK-NEXT:     %7 = llvm.inttoptr %c1_i256 : i256 to !llvm.ptr<1> loc(#loc7)
// CHECK-NEXT:     %8 = llvm.inttoptr %5 : i256 to !llvm.ptr<4> loc(#loc7)
// CHECK-NEXT:     "llvm.intrcall"(%c0_i256, %7, %8, %6) <{id = 3709 : i32, name = "evm.extcodecopy"}> : (i256, !llvm.ptr<1>, !llvm.ptr<4>, i256) -> () loc(#loc7)
