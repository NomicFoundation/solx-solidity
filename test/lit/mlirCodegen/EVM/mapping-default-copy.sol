...
// CHECK-NEXT:       %1 = call @get_33() : () -> i256 loc(#loc4)
...
// CHECK-NEXT:       %4 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:       llvm.store %1, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:       %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc4)
// CHECK-NEXT:       %6 = "llvm.intrcall"(%5, %c64_i256) <{id = 4085 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc4)
...
// CHECK-NEXT:       llvm.store %c2_i256, %0 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc9)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:19:11)
// CHECK-NEXT: #loc5 = loc({{.*}}:19:17)
