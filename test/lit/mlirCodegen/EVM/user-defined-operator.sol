...
// CHECK-NEXT: #loc15 = loc({{.*}}:6:13)
// CHECK-NEXT: #loc16 = loc({{.*}}:6:20)
...
// CHECK-NEXT:       %4 = call @neg_52(%3) : (i256) -> i256 loc(#loc7)
// CHECK-NEXT:       %5 = call @add_33(%2, %4) : (i256, i256) -> i256 loc(#loc5)
...
// CHECK-NEXT:       %2 = "llvm.intrcall"(%c3_i256, %c0_i256) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc12)
// CHECK-NEXT:       %3 = "llvm.intrcall"(%c3_i256, %1) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc12)
// CHECK-NEXT:       %4 = arith.subi %2, %3 : i256 loc(#loc12)
// CHECK-NEXT:       %5 = arith.cmpi sgt, %4, %c2147483647_i256 : i256 loc(#loc12)
// CHECK-NEXT:       %6 = arith.cmpi slt, %4, %c-2147483648_i256 : i256 loc(#loc12)
...
// CHECK-NEXT:       %3 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc18)
// CHECK-NEXT:       %4 = "llvm.intrcall"(%c3_i256, %2) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc19)
// CHECK-NEXT:       %5 = "llvm.intrcall"(%c3_i256, %3) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc19)
// CHECK-NEXT:       %6 = arith.addi %4, %5 : i256 loc(#loc19)
// CHECK-NEXT:       %7 = arith.cmpi sgt, %6, %c2147483647_i256 : i256 loc(#loc19)
// CHECK-NEXT:       %8 = arith.cmpi slt, %6, %c-2147483648_i256 : i256 loc(#loc19)
// CHECK-NEXT:       %9 = arith.ori %7, %8 : i1 loc(#loc19)
...
// CHECK-NEXT:       llvm.store %c17_i256, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc19)
...
// CHECK-NEXT:     ^bb2:  // 2 preds: ^bb0, ^bb1
// CHECK-NEXT:       return %6 : i256 loc(#loc20)
...
// CHECK-NEXT: #loc14 = loc({{.*}}:6:0)
// CHECK-NEXT: #loc17 = loc({{.*}}:7:31)
// CHECK-NEXT: #loc18 = loc({{.*}}:7:47)
// CHECK-NEXT: #loc19 = loc({{.*}}:7:20)
