...
// CHECK-NEXT:       %14 = "llvm.intrcall"(%c3_i256, %13) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:       %19 = "llvm.intrcall"(%c3_i256, %18) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:       %25 = "llvm.intrcall"(%c3_i256, %22) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:       %3 = "llvm.intrcall"(%c3_i256, %c0_i256) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc14)
// CHECK-NEXT:       %4 = "llvm.intrcall"(%c3_i256, %2) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc14)
...
// CHECK-NEXT:       "llvm.intrcall"(%11, %c36_i256) <{id = 4080 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc14)
...
// CHECK-NEXT:       %5 = "llvm.intrcall"(%c3_i256, %3) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc22)
// CHECK-NEXT:       %6 = "llvm.intrcall"(%c3_i256, %4) <{id = 4088 : i32, name = "evm.signextend"}> : (i256, i256) -> i256 loc(#loc22)
