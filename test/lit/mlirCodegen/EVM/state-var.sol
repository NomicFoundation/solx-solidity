...
// CHECK-NEXT:       "llvm.intrcall"(%1, %c0_i256_0) <{id = 3254 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc2)
// CHECK-NEXT:       call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:       llvm.unreachable loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:       %8 = "llvm.intrcall"(%7, %c32_i256_0) <{id = 3259 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc6)
...
// CHECK-NEXT:       %6 = "llvm.intrcall"(%5, %c64_i256) <{id = 3259 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc14)
...
// CHECK-NEXT:       %11 = "llvm.intrcall"(%10, %c64_i256_3) <{id = 3259 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc14)
...
// CHECK-NEXT:       %5 = "llvm.intrcall"(%4, %c64_i256) <{id = 3259 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc21)
