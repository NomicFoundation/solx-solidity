...
// CHECK-NEXT:       llvm.store %c1_i256, %2 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc9)
// CHECK-NEXT:       llvm.store %c0_i256, %3 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc10)
// CHECK-NEXT:       %4 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc11)
// CHECK-NEXT:       %5 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc11)
// CHECK-NEXT:       %6 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc11)
// CHECK-NEXT:       %7 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc11)
// CHECK-NEXT:       return %4, %5, %6, %7 : i256, i256, i256, i256 loc(#loc12)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c1_i256, %0 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc14)
// CHECK-NEXT:       %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc15)
// CHECK-NEXT:       %2 = arith.addi %1, %c1_i256 : i256 loc(#loc16)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:15:13)
// CHECK-NEXT: #loc5 = loc({{.*}}:15:22)
// CHECK-NEXT: #loc6 = loc({{.*}}:15:31)
// CHECK-NEXT: #loc7 = loc({{.*}}:17:6)
// CHECK-NEXT: #loc8 = loc({{.*}}:18:6)
// CHECK-NEXT: #loc9 = loc({{.*}}:19:6)
// CHECK-NEXT: #loc10 = loc({{.*}}:20:6)
// CHECK-NEXT: #loc11 = loc({{.*}}:22:11)
// CHECK-NEXT: #loc12 = loc({{.*}}:22:4)
// CHECK-NEXT: #loc13 = loc({{.*}}:6:2)
// CHECK-NEXT: #loc14 = loc({{.*}}:7:4)
// CHECK-NEXT: #loc15 = loc({{.*}}:9:15)
// CHECK-NEXT: #loc16 = loc({{.*}}:9:11)
// CHECK-NEXT: #loc17 = loc({{.*}}:9:6)
// CHECK-NEXT: #loc18 = loc({{.*}}:11:11)
