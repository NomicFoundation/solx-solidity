...
// CHECK-NEXT:       %22 = call @eq_16(%14, %19) : (i256, i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:       %25 = arith.cmpi ne, %22, %c0_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:       %45 = call @ne_32(%37, %42) : (i256, i256) -> i256 loc(#loc1)
