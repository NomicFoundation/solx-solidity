...
// CHECK-NEXT:       %2 = arith.andi %1, %c255_i256 : i256 loc(#loc4)
...
// CHECK-NEXT:       %2 = arith.cmpi ne, %1, %c0_i256 : i256 loc(#loc8)
// CHECK-NEXT:       %3 = arith.extui %2 : i1 to i256 loc(#loc8)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:4:74)
// CHECK-NEXT: #loc5 = loc({{.*}}:4:54)
// CHECK-NEXT: #loc6 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc8 = loc({{.*}}:3:60)
// CHECK-NEXT: #loc9 = loc({{.*}}:3:53)
// CHECK-EMPTY:
