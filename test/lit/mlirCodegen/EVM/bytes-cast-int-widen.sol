...
// CHECK-NEXT:       %14 = call @f_12(%13) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:       %17 = arith.cmpi ne, %14, %c0_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:       %29 = arith.andi %28, %c255_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:       %32 = call @g_28(%29) : (i256) -> i256 loc(#loc1)
