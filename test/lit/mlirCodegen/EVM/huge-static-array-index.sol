...
// CHECK-NEXT:       %2 = arith.cmpi uge, %1, %c36893488147419103232_i256 : i256 loc(#loc5)
...
// CHECK-NEXT:       %c18446744073709551623_i256 = arith.constant 18446744073709551623 : i256 loc(#loc8)
// CHECK-NEXT:       %c1_i256 = arith.constant 1 : i256 loc(#loc8)
// CHECK-NEXT:       %0 = llvm.inttoptr %c18446744073709551623_i256 : i256 to !llvm.ptr<5> loc(#loc8)
// CHECK-NEXT:       llvm.store %c1_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc8)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:11:19)
// CHECK-NEXT: #loc5 = loc({{.*}}:11:15)
