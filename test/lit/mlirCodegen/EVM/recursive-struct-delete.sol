...
// CHECK-NEXT:     %4 = "llvm.intrcall"() <{id = 4047 : i32, metadata = ["C_19"], name = "evm.datasize"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:     %23 = "llvm.intrcall"() <{id = 4046 : i32, metadata = ["C_19_deployed"], name = "evm.dataoffset"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:     %24 = "llvm.intrcall"() <{id = 4047 : i32, metadata = ["C_19_deployed"], name = "evm.datasize"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:       %6 = arith.addi %arg0, %c1_i256 : i256 loc(#loc2)
// CHECK-NEXT:       %7 = llvm.inttoptr %6 : i256 to !llvm.ptr<5> loc(#loc2)
// CHECK-NEXT:       %8 = llvm.load %7 {alignment = 1 : i64} : !llvm.ptr<5> -> i256 loc(#loc2)
// CHECK-NEXT:       %9 = llvm.inttoptr %6 : i256 to !llvm.ptr<5> loc(#loc2)
// CHECK-NEXT:       llvm.store %c0_i256, %9 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc2)
// CHECK-NEXT:       %10 = arith.cmpi ugt, %8, %c0_i256 : i256 loc(#loc2)
// CHECK-NEXT:       cf.cond_br %10, ^bb4, ^bb7 loc(#loc2)
// CHECK-NEXT:     ^bb4:  // pred: ^bb3
// CHECK-NEXT:       %11 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %6, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %12 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %13 = "llvm.intrcall"(%12, %c32_i256) <{id = 4085 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc2)
// CHECK-NEXT:       %14 = arith.muli %8, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:       cf.br ^bb5(%c0_i256 : i256) loc(#loc2)
// CHECK-NEXT:     ^bb5(%15: i256 loc({{.*}}:11:4)):  // 2 preds: ^bb4, ^bb6
// CHECK-NEXT:       %16 = arith.cmpi ult, %15, %14 : i256 loc(#loc2)
// CHECK-NEXT:       cf.cond_br %16, ^bb6(%15 : i256), ^bb7 loc(#loc2)
// CHECK-NEXT:     ^bb6(%17: i256 loc({{.*}}:11:4)):  // pred: ^bb5
// CHECK-NEXT:       %18 = arith.addi %13, %17 : i256 loc(#loc2)
// CHECK-NEXT:       call @__sol.clear_storage.S_8(%18) : (i256) -> () loc(#loc2)
// CHECK-NEXT:       %19 = arith.addi %17, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:       cf.br ^bb5(%19 : i256) loc(#loc2)
