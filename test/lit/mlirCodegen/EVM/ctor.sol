...
// CHECK-NEXT:       "llvm.intrcall"(%28, %c0_i256_4) <{id = 3254 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %6 = llvm.inttoptr %c64_i256_0 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:       %30 = llvm.inttoptr %c0_i256_5 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %12 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %15 = arith.addi %7, %5 : i256 loc(#loc1)
// CHECK-NEXT:     %16 = arith.subi %15, %7 : i256 loc(#loc1)
...
// CHECK-NEXT:     %20 = arith.addi %7, %c32_i256_2 : i256 loc(#loc1)
...
// CHECK-NEXT:     %23 = "llvm.intrcall"() <{id = 3222 : i32, metadata = ["C_13_deployed"], name = "evm.dataoffset"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:     %24 = "llvm.intrcall"() <{id = 3223 : i32, metadata = ["C_13_deployed"], name = "evm.datasize"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:     "llvm.intrcall"(%27, %24) <{id = 3252 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
