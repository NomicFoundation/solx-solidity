...
// CHECK-NEXT:       "llvm.intrcall"(%25, %c0_i256) <{id = 3255 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
...
// CHECK-NEXT:       "llvm.intrcall"(%27, %c36_i256) <{id = 3255 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
...
// CHECK-NEXT:     "llvm.intrcall"(%24, %21) <{id = 3253 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
