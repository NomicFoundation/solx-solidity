...
// CHECK-NEXT:       %9 = "llvm.intrcall"(%8, %c64_i256) <{id = 4085 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc11)
...
// CHECK-NEXT:       %15 = "llvm.intrcall"(%14, %c64_i256) <{id = 4085 : i32, name = "evm.sha3"}> : (!llvm.ptr<1>, i256) -> i256 loc(#loc11)
