...
// CHECK-NEXT:     ^bb1(%0: i256 loc({{.*}}:12:8)):  // 2 preds: ^bb0, ^bb2
// CHECK-NEXT:       %1 = arith.cmpi ult, %0, %c1_i256 : i256 loc(#loc5)
// CHECK-NEXT:       cf.cond_br %1, ^bb2(%0 : i256), ^bb3(%c0_i256 : i256) loc(#loc5)
// CHECK-NEXT:     ^bb2(%2: i256 loc({{.*}}:12:8)):  // pred: ^bb1
// CHECK-NEXT:       %3 = llvm.inttoptr %2 : i256 to !llvm.ptr<5> loc(#loc5)
// CHECK-NEXT:       llvm.store %c0_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc5)
// CHECK-NEXT:       %4 = arith.addi %2, %c1_i256 : i256 loc(#loc5)
// CHECK-NEXT:       cf.br ^bb1(%4 : i256) {loop_annotation = #loop_annotation} loc(#loc5)
// CHECK-NEXT:     ^bb3(%5: i256 loc({{.*}}:12:8)):  // 2 preds: ^bb1, ^bb4
// CHECK-NEXT:       %6 = arith.cmpi ult, %5, %c18446744073709551616_i256 : i256 loc(#loc5)
// CHECK-NEXT:       cf.cond_br %6, ^bb4(%5 : i256), ^bb5(%c0_i256 : i256) loc(#loc5)
// CHECK-NEXT:     ^bb4(%7: i256 loc({{.*}}:12:8)):  // pred: ^bb3
// CHECK-NEXT:       %8 = arith.addi %7, %c1_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %9 = llvm.inttoptr %8 : i256 to !llvm.ptr<5> loc(#loc5)
// CHECK-NEXT:       llvm.store %c0_i256, %9 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc5)
// CHECK-NEXT:       %10 = arith.addi %7, %c1_i256 : i256 loc(#loc5)
// CHECK-NEXT:       cf.br ^bb3(%10 : i256) loc(#loc5)
// CHECK-NEXT:     ^bb5(%11: i256 loc({{.*}}:12:8)):  // 2 preds: ^bb3, ^bb6
// CHECK-NEXT:       %12 = arith.cmpi ult, %11, %c1_i256 : i256 loc(#loc5)
// CHECK-NEXT:       cf.cond_br %12, ^bb6(%11 : i256), ^bb7 loc(#loc5)
// CHECK-NEXT:     ^bb6(%13: i256 loc({{.*}}:12:8)):  // pred: ^bb5
// CHECK-NEXT:       %14 = arith.addi %13, %c18446744073709551617_i256 : i256 loc(#loc5)
...
// CHECK-NEXT:       cf.br ^bb5(%16 : i256) {loop_annotation = #loop_annotation} loc(#loc5)
