...
// CHECK-NEXT:   func.func @f_41(%arg0: i1 loc({{.*}}:2:11), %arg1: i1 loc({{.*}}:2:19), %arg2: i1 loc({{.*}}:2:27)) -> i1 attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
...
// CHECK-NEXT:     %19 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc13)
// CHECK-NEXT:     %20 = arith.cmpi eq, %19, %false : i1 loc(#loc14)
// CHECK-NEXT:     %21 = llvm.alloca %c1_i256 x i1 : (i256) -> !llvm.ptr loc(#loc15)
// CHECK-NEXT:     llvm.store %20, %21 {alignment = 32 : i64} : i1, !llvm.ptr loc(#loc15)
// CHECK-NEXT:     %22 = llvm.load %10 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc16)
// CHECK-NEXT:     %23 = llvm.alloca %c1_i256 x i1 : (i256) -> !llvm.ptr loc(#loc16)
// CHECK-NEXT:     llvm.store %false, %23 {alignment = 32 : i64} : i1, !llvm.ptr loc(#loc16)
// CHECK-NEXT:     cf.cond_br %22, ^bb9, ^bb10 loc(#loc16)
// CHECK-NEXT:   ^bb9:  // pred: ^bb8
// CHECK-NEXT:     %24 = llvm.load %18 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc17)
// CHECK-NEXT:     llvm.store %24, %23 {alignment = 32 : i64} : i1, !llvm.ptr loc(#loc16)
// CHECK-NEXT:     cf.br ^bb10 loc(#loc16)
// CHECK-NEXT:   ^bb10:  // 2 preds: ^bb8, ^bb9
// CHECK-NEXT:     %25 = llvm.load %23 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc16)
// CHECK-NEXT:     %26 = llvm.alloca %c1_i256 x i1 : (i256) -> !llvm.ptr loc(#loc16)
// CHECK-NEXT:     llvm.store %false, %26 {alignment = 32 : i64} : i1, !llvm.ptr loc(#loc16)
// CHECK-NEXT:     cf.cond_br %25, ^bb11, ^bb12 loc(#loc16)
// CHECK-NEXT:   ^bb11:  // pred: ^bb10
// CHECK-NEXT:     %27 = llvm.load %21 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc18)
// CHECK-NEXT:     llvm.store %27, %26 {alignment = 32 : i64} : i1, !llvm.ptr loc(#loc16)
// CHECK-NEXT:     cf.br ^bb12 loc(#loc16)
// CHECK-NEXT:   ^bb12:  // 2 preds: ^bb10, ^bb11
// CHECK-NEXT:     %28 = llvm.load %26 {alignment = 32 : i64} : !llvm.ptr -> i1 loc(#loc16)
// CHECK-NEXT:     return %28 : i1 loc(#loc19)
// CHECK-NEXT:   } loc(#loc1)
// CHECK-NEXT: } loc(#loc)
