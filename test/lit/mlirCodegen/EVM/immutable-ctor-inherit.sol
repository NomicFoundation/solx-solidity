...
// CHECK-NEXT:       %0 = "llvm.intrcall"() <{id = 4060 : i32, metadata = ["a_2"], name = "evm.loadimmutable"}> : () -> i256 loc(#loc5)
// CHECK-NEXT:       %1 = "llvm.intrcall"() <{id = 4060 : i32, metadata = ["b_15"], name = "evm.loadimmutable"}> : () -> i256 loc(#loc6)
// CHECK-NEXT:       return %0, %1 : i256, i256 loc(#loc7)
// CHECK-NEXT:     } loc(#loc4)
// CHECK-NEXT:     func.func @_10() attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
// CHECK-NEXT:       %c160_i256 = arith.constant 160 : i256 loc(#loc5)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc9)
// CHECK-NEXT:       %0 = llvm.inttoptr %c160_i256 : i256 to !llvm.ptr<1> loc(#loc9)
