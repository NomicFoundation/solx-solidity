...
// CHECK-NEXT:     %4 = "llvm.intrcall"() <{id = 4047 : i32, metadata = ["C_56"], name = "evm.datasize"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:     %23 = "llvm.intrcall"() <{id = 4046 : i32, metadata = ["C_56_deployed"], name = "evm.dataoffset"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:     %24 = "llvm.intrcall"() <{id = 4047 : i32, metadata = ["C_56_deployed"], name = "evm.datasize"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:     call @m_6(%c0_i256) : (i256) -> () loc(#loc4)
// CHECK-NEXT:     call @_290() : () -> () loc(#loc2)
...
// CHECK-NEXT:       call @f_43(%13) : (i256) -> () loc(#loc1)
...
// CHECK-NEXT:       call @g_55(%24) : (i256) -> () loc(#loc1)
...
// CHECK-NEXT:       llvm.unreachable loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     func.func @o_220(%arg0: i256 loc({{.*}}:9:13)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
...
// CHECK-NEXT:       call @n_12(%arg0) : (i256) -> () loc(#loc8)
// CHECK-NEXT:       call @g_550(%arg0) : (i256) -> () loc(#loc9)
// CHECK-NEXT:       %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr -> i256 loc(#loc10)
// CHECK-NEXT:       call @f_43(%1) : (i256) -> () loc(#loc11)
...
// CHECK-NEXT:     func.func @g_550(%arg0: i256 loc({{.*}}:9:13)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
...
// CHECK-NEXT:     func.func @g_55(%arg0: i256 loc({{.*}}:9:2)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
// CHECK-NEXT:       call @o_220(%arg0) : (i256) -> () loc(#loc14)
// CHECK-NEXT:       return loc(#loc14)
// CHECK-NEXT:     } loc(#loc14)
// CHECK-NEXT:     func.func @f_430(%arg0: i256 loc({{.*}}:8:13)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
...
// CHECK-NEXT:     func.func @f_43(%arg0: i256 loc({{.*}}:8:2)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
// CHECK-NEXT:       %c36_i256 = arith.constant 36 : i256 loc(#loc)
...
// CHECK-NEXT:       %1 = arith.cmpi ugt, %arg0, %0 : i256 loc(#loc18)
// CHECK-NEXT:       cf.cond_br %1, ^bb1, ^bb2 loc(#loc18)
// CHECK-NEXT:     ^bb1:  // pred: ^bb0
// CHECK-NEXT:       %2 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc18)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256, %2 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc18)
// CHECK-NEXT:       %3 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc18)
// CHECK-NEXT:       llvm.store %c17_i256, %3 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc18)
// CHECK-NEXT:       %4 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc18)
// CHECK-NEXT:       "llvm.intrcall"(%4, %c36_i256) <{id = 4080 : i32, name = "evm.revert"}> : (!llvm.ptr<1>, i256) -> () loc(#loc18)
// CHECK-NEXT:       call @".unreachable"() : () -> () loc(#loc18)
// CHECK-NEXT:       cf.br ^bb2 loc(#loc18)
// CHECK-NEXT:     ^bb2:  // 2 preds: ^bb0, ^bb1
// CHECK-NEXT:       call @n_12(%0) : (i256) -> () loc(#loc19)
// CHECK-NEXT:       call @f_430(%arg0) : (i256) -> () loc(#loc15)
// CHECK-NEXT:       return loc(#loc15)
// CHECK-NEXT:     } loc(#loc15)
// CHECK-NEXT:     func.func @_290() attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"]} {
// CHECK-NEXT:       return loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
