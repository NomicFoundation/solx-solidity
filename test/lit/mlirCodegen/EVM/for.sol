...
// CHECK-NEXT:   func.func @f_29(%arg0: i256 loc({{.*}}:2:11)) attributes {llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], state_mutability = #NonPayable} {
