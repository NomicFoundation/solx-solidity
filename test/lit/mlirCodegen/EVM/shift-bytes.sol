...
// CHECK-NEXT:       %7 = "llvm.intrcall"(%6, %5) <{id = 4087 : i32, name = "evm.shr"}> : (i256, i256) -> i256 loc(#loc6)
...
// CHECK-NEXT:       %7 = "llvm.intrcall"(%6, %5) <{id = 4086 : i32, name = "evm.shl"}> : (i256, i256) -> i256 loc(#loc13)
