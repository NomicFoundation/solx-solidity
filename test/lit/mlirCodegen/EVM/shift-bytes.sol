...
// CHECK-NEXT:       %4 = arith.andi %2, %c-79228162514264337593543950336_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %5 = arith.andi %3, %c255_i256 : i256 loc(#loc5)
// CHECK-NEXT:       %6 = "llvm.intrcall"(%5, %4) <{id = 4087 : i32, name = "evm.shr"}> : (i256, i256) -> i256 loc(#loc5)
...
// CHECK-NEXT:       %4 = arith.andi %2, %c-79228162514264337593543950336_i256 : i256 loc(#loc11)
// CHECK-NEXT:       %5 = arith.andi %3, %c255_i256 : i256 loc(#loc11)
// CHECK-NEXT:       %6 = "llvm.intrcall"(%5, %4) <{id = 4086 : i32, name = "evm.shl"}> : (i256, i256) -> i256 loc(#loc11)
