...
// CHECK-NEXT:       %28 = llvm.insertvalue %24, %0[0] : !llvm.struct<(i256, i256)>  loc(#loc1)
// CHECK-NEXT:       %29 = llvm.insertvalue %23, %28[1] : !llvm.struct<(i256, i256)>  loc(#loc1)
// CHECK-NEXT:       %30 = call @len_11(%29) : (!llvm.struct<(i256, i256)>) -> i256 loc(#loc1)
...
// CHECK-NEXT:       llvm.store %30, %33 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:       %34 = llvm.inttoptr %32 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:       "llvm.intrcall"(%34, %c32_i256) <{id = 4078 : i32, name = "evm.return"}> : (!llvm.ptr<1>, i256) -> () loc(#loc1)
// CHECK-NEXT:       call @".unreachable"() : () -> () loc(#loc1)
