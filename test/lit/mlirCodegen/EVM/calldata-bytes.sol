...
// CHECK-NEXT:       %27 = llvm.insertvalue %23, %0[0] : !llvm.struct<(i256, i256)>  loc(#loc1)
// CHECK-NEXT:       %28 = llvm.insertvalue %22, %27[1] : !llvm.struct<(i256, i256)>  loc(#loc1)
// CHECK-NEXT:       %29 = call @len_11(%28) : (!llvm.struct<(i256, i256)>) -> i256 loc(#loc1)
...
// CHECK-NEXT:     ^bb13:  // 3 preds: ^bb0, ^bb1, ^bb12
