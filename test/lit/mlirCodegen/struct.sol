...
// CHECK-NEXT:     %5 = sol.gep %4, %c1_ui64 : !sol.struct<(ui256, !sol.array<3 x ui256, Memory>), Memory>, ui64, !sol.array<3 x ui256, Memory> loc(#loc4)
// CHECK-NEXT:     %c2_ui8 = sol.constant 2 : ui8 loc(#loc5)
// CHECK-NEXT:     %6 = sol.gep %5, %c2_ui8 : !sol.array<3 x ui256, Memory>, ui8, !sol.ptr<ui256, Memory> loc(#loc4)
// CHECK-NEXT:     %7 = sol.load %6 : !sol.ptr<ui256, Memory>, ui256 loc(#loc4)
// CHECK-NEXT:     %8 = sol.cadd %3, %7 : ui256 loc(#loc3)
// CHECK-NEXT:     sol.return %8 : ui256 loc(#loc6)
// CHECK-NEXT:   } loc(#loc1)
