...
// CHECK-NEXT:       %0 = sol.new "C_9" value = %c0_ui256 ctor() : !sol.contract<"C_9"> loc(#loc3)
// CHECK-NEXT:       %1 = sol.alloca : !sol.ptr<!sol.contract<"C_9">, Stack> loc(#loc4)
// CHECK-NEXT:       sol.store %0, %1 : !sol.contract<"C_9">, !sol.ptr<!sol.contract<"C_9">, Stack> loc(#loc4)
// CHECK-NEXT:       %2 = sol.load %1 : !sol.ptr<!sol.contract<"C_9">, Stack>, !sol.contract<"C_9"> loc(#loc5)
// CHECK-NEXT:       %3 = sol.alloca : !sol.ptr<!sol.contract<"C_9">, Stack> loc(#loc6)
// CHECK-NEXT:       sol.store %2, %3 : !sol.contract<"C_9">, !sol.ptr<!sol.contract<"C_9">, Stack> loc(#loc6)
// CHECK-NEXT:       %4 = sol.load %3 : !sol.ptr<!sol.contract<"C_9">, Stack>, !sol.contract<"C_9"> loc(#loc7)
// CHECK-NEXT:       %5 = sol.address_cast %4 : !sol.contract<"C_9"> to !sol.address loc(#loc7)
...
// CHECK-NEXT:       sol.store %0, %1 : !sol.contract<"C_9">, !sol.ptr<!sol.contract<"C_9">, Stack> loc(#loc12)
...
// CHECK-NEXT:       %2 = sol.address_cast %1 : !sol.address<payable> to !sol.address loc(#loc18)
...
// CHECK-NEXT:       %1 = sol.load %0 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc26)
// CHECK-NEXT:       %2 = sol.code_size %1 : !sol.address -> ui256 loc(#loc26)
// CHECK-NEXT:       sol.return %2 : ui256 loc(#loc27)
