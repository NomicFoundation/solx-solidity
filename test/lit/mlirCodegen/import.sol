...
// CHECK-NEXT:       %c12_ui8 = sol.constant 12 : ui8 loc(#loc4)
// CHECK-NEXT:       %1 = sol.cast %c12_ui8 : ui8 to ui256 loc(#loc4)
...
// CHECK-NEXT: #loc4 = loc({{.*}}:5:46)
// CHECK-NEXT: #loc5 = loc({{.*}}:5:39)
...
// CHECK-NEXT:       %c0_ui256 = sol.constant 0 : ui256 loc(#loc3)
// CHECK-NEXT:       sol.store %c0_ui256, %0 : ui256, !sol.ptr<ui256, Stack> loc(#loc3)
// CHECK-NEXT:       %c13_ui8 = sol.constant 13 : ui8 loc(#loc4)
// CHECK-NEXT:       %1 = sol.cast %c13_ui8 : ui8 to ui256 loc(#loc4)
// CHECK-NEXT:       sol.return %1 : ui256 loc(#loc5)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:   } {kind = #Contract} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
