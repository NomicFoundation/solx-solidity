...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc5)
// CHECK-NEXT:     llvm.store %0, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
...
// CHECK-NEXT:     %3 = llvm.alloca %c1_i256_3 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     llvm.store %2, %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
...
// CHECK-NEXT:     %5 = llvm.alloca %c1_i256_6 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc15)
// CHECK-NEXT:     llvm.store %4, %5 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc14)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT: } loc(#loc)
