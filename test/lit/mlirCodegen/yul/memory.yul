...
// CHECK-NEXT:     %0 = yul.memoryguard 1 loc(#loc2)
// CHECK-NEXT:     yul.mstore %c0_i256, %0 loc(#loc3)
// CHECK-NEXT:     %c0_i256_0 = yul.constant 0 : i256 : i256 loc(#loc4)
// CHECK-NEXT:     %c1_i256 = yul.constant 1 : i256 : i256 loc(#loc5)
// CHECK-NEXT:     %1 = yul.mload %c1_i256 loc(#loc6)
// CHECK-NEXT:     yul.mstore %c0_i256_0, %1 loc(#loc7)
// CHECK-NEXT:     %c0_i256_1 = yul.constant 0 : i256 : i256 loc(#loc8)
// CHECK-NEXT:     %c10_i256 = yul.constant 10 : i256 : i256 loc(#loc9)
// CHECK-NEXT:     %c5_i256 = yul.constant 5 : i256 : i256 loc(#loc10)
// CHECK-NEXT:     yul.mcopy %c0_i256_1, %c10_i256, %c5_i256 loc(#loc11)
// CHECK-NEXT:     %c0_i256_2 = yul.constant 0 : i256 : i256 loc(#loc12)
// CHECK-NEXT:     %c0_i256_3 = yul.constant 0 : i256 : i256 loc(#loc13)
// CHECK-NEXT:     %c255_i256 = yul.constant 255 : i256 : i256 loc(#loc14)
// CHECK-NEXT:     %2 = yul.byte %c0_i256_3, %c255_i256 loc(#loc15)
// CHECK-NEXT:     yul.mstore8 %c0_i256_2, %2 loc(#loc16)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT: } loc(#loc)
