...
// CHECK-NEXT:     %c0_i256_1 = yul.constant 0 loc(#loc8)
// CHECK-NEXT:     %c10_i256 = yul.constant 10 loc(#loc9)
// CHECK-NEXT:     %c5_i256 = yul.constant 5 loc(#loc10)
// CHECK-NEXT:     yul.mcopy %c0_i256_1, %c10_i256, %c5_i256 loc(#loc11)
// CHECK-NEXT:     %c0_i256_2 = yul.constant 0 loc(#loc12)
// CHECK-NEXT:     %c0_i256_3 = yul.constant 0 loc(#loc13)
// CHECK-NEXT:     %c255_i256 = yul.constant 255 loc(#loc14)
