...
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256_0 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     llvm.store %0, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
...
// CHECK-NEXT:     llvm.store %2, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc18)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT: } loc(#loc)
