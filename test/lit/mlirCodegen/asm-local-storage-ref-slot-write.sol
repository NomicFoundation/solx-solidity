...
// CHECK-NEXT:       %5 = sol.conv_cast %1 : !sol.ptr<!sol.struct<(ui256), Storage>, Stack> -> !llvm.ptr loc(#loc5)
// CHECK-NEXT:       llvm.store %4, %5 {alignment = 32 : i64} : i256, !llvm.ptr loc(#loc7)
// CHECK-NEXT:       %6 = sol.load %1 : !sol.ptr<!sol.struct<(ui256), Storage>, Stack>, !sol.struct<(ui256), Storage> loc(#loc2)
// CHECK-NEXT:       sol.return %6 : !sol.struct<(ui256), Storage> loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
