...
// CHECK-NEXT:     llvm.store %c0_i256, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc4)
...
// CHECK-NEXT:     cf.cond_br %4, ^bb2, ^bb4 loc(#loc6)
// CHECK-NEXT:   ^bb2:  // pred: ^bb1
// CHECK-NEXT:     %5 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     %6 = arith.cmpi eq, %5, %c1_i256 : i256 loc(#loc8)
// CHECK-NEXT:     cf.cond_br %6, ^bb4, ^bb3 loc(#loc9)
// CHECK-NEXT:   ^bb3:  // pred: ^bb2
// CHECK-NEXT:     %7 = llvm.load %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     %8 = arith.addi %7, %c1_i256 : i256 loc(#loc10)
// CHECK-NEXT:     llvm.store %8, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
// CHECK-NEXT:     cf.br ^bb1 loc(#loc5)
