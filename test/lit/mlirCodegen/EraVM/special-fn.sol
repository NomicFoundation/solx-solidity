...
// CHECK-NEXT:       %11 = llvm.getelementptr %10[%c0_i256_4] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:       %12 = llvm.load %11 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:       %c224_i256 = arith.constant 224 : i256 loc(#loc1)
// CHECK-NEXT:       %13 = arith.shrui %12, %c224_i256 : i256 loc(#loc1)
// CHECK-NEXT:       %14 = arith.trunci %13 : i256 to i32 loc(#loc1)
// CHECK-NEXT:       scf.int_switch %14 : i32
// CHECK-NEXT:       case 638722032 {
// CHECK-NEXT:         %15 = "llvm.intrcall"() <{id = 3178 : i32, name = "eravm.getu128"}> : () -> i256 loc(#loc1)
// CHECK-NEXT:         %c0_i256_5 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:         %16 = arith.cmpi ne, %15, %c0_i256_5 : i256 loc(#loc1)
...
// CHECK-NEXT:       func.call @__return(%c0_i256_4, %c0_i256_5, %c0_i256_6) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
...
// CHECK-NEXT:     %8 = arith.cmpi ne, %7, %c0_i256_0 : i256 loc(#loc1)
// CHECK-NEXT:     scf.if %8 {
// CHECK-NEXT:       %c0_i256_4 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:       %c0_i256_5 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:       func.call @__revert(%c0_i256_4, %c0_i256_4, %c0_i256_5) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
...
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c0_i256_3 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c0_i256_1, %c0_i256_2, %c0_i256_3) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:     call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
