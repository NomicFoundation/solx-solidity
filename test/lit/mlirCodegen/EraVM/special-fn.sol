...
// CHECK-NEXT:     scf.if %3 {
// CHECK-NEXT:       %9 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:       %10 = llvm.load %9 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:       %11 = llvm.load %10 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc1)
// CHECK-NEXT:       %12 = arith.shrui %11, %c224_i256 : i256 loc(#loc1)
// CHECK-NEXT:       %13 = arith.trunci %12 : i256 to i32 loc(#loc1)
// CHECK-NEXT:       scf.int_switch %13 : i32
// CHECK-NEXT:       case 638722032 {
// CHECK-NEXT:         %14 = "llvm.intrcall"() <{id = 3178 : i32, name = "eravm.getu128"}> : () -> i256 loc(#loc1)
...
// CHECK-NEXT:       } loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %4 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc1)
// CHECK-NEXT:     %5 = llvm.load %4 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc1)
...
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %7 = "llvm.intrcall"() <{id = 3178 : i32, name = "eravm.getu128"}> : () -> i256 loc(#loc1)
