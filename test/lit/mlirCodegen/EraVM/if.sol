...
// CHECK-NEXT:     %2 = llvm.alloca %c1_i256 x i256 : (i256) -> !llvm.ptr<i256> loc(#loc2)
...
// CHECK-NEXT:     %6 = arith.select %5, %0, %1 : !llvm.ptr<i256> loc(#loc7)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc8)
// CHECK-NEXT:     llvm.store %7, %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
