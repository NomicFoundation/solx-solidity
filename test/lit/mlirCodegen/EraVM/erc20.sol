...
// CHECK-NEXT:     scf.if %9 {
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %72 = llvm.inttoptr %c0_i256_29 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       func.call @__revert(%c0_i256_30, %c24_i256, %c2_i256_31) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_30 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%c0_i256_29, %c0_i256_29, %c2_i256_30) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:       %c64_i256_29 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:       %72 = llvm.inttoptr %c64_i256_29 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c32_i256_30, %76 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %77 = arith.addi %75, %c32_i256_30 : i256 loc(#loc2)
...
// CHECK-NEXT:       %c2_i256_33 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%73, %83, %c2_i256_33) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
...
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %72 = llvm.inttoptr %c0_i256_29 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_6, %72 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %73 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %73 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %39 = arith.addi %5, %c32_i256_9 : i256 loc(#loc2)
...
// CHECK-NEXT:       %c0_i256_29 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %72 = llvm.inttoptr %c0_i256_29 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_16, %72 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %73 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %73 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %67 = llvm.getelementptr %66[%c0_i256_21] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%64, %67, %c0_i256_22) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     llvm.store %c32_i256_23, %68 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
...
// CHECK-NEXT:     llvm.store %c0_i256_24, %69 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_25 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     %70 = arith.muli %c0_i256_25, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_26 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %71 = arith.addi %70, %c64_i256_26 : i256 loc(#loc2)
// CHECK-NEXT:     %c256_i256_27 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256_28 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     call @__return(%c256_i256_27, %71, %c2_i256_28) : (i256, i256, i256) -> () loc(#loc2)
