...
// CHECK-NEXT:       func.call @__revert(%c0_i256_30, %c0_i256_30, %c2_i256_31) : (i256, i256, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     %5 = arith.subi %4, %c0_i256_0 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %6 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       %c0_i256_30 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %74 = llvm.inttoptr %c0_i256_30 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       %c0_i256_31 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %c24_i256 = arith.constant 24 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_32 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%c0_i256_31, %c24_i256, %c2_i256_32) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     %c64_i256_2 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %12 = llvm.inttoptr %c64_i256_2 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %16 = llvm.getelementptr %15[%c0_i256_0] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%13, %16, %5) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %17 = arith.addi %7, %5 : i256 loc(#loc2)
// CHECK-NEXT:     %18 = arith.subi %17, %7 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_3 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %19 = arith.cmpi slt, %18, %c64_i256_3 : i256 loc(#loc2)
...
// CHECK-NEXT:     %22 = arith.addi %7, %21 : i256 loc(#loc2)
// CHECK-NEXT:     %c18446744073709551615_i256_4 = arith.constant 18446744073709551615 : i256 loc(#loc2)
// CHECK-NEXT:     %23 = arith.cmpi ugt, %22, %c18446744073709551615_i256_4 : i256 loc(#loc2)
// CHECK-NEXT:     scf.if %23 {
// CHECK-NEXT:       %c64_i256_30 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:       %74 = llvm.inttoptr %c64_i256_30 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %75 = llvm.load %74 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c3963877391197344453575983046348115674221700746820753546331534351508065746944_i256, %76 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %77 = arith.addi %75, %c4_i256 : i256 loc(#loc2)
// CHECK-NEXT:       %c32_i256_31 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %78 = llvm.inttoptr %77 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c32_i256_31, %78 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %79 = arith.addi %77, %c32_i256_31 : i256 loc(#loc2)
// CHECK-NEXT:       %c34_i256 = arith.constant 34 : i256 loc(#loc2)
// CHECK-NEXT:       %80 = llvm.inttoptr %79 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c34_i256, %80 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c32_i256_32 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %81 = arith.addi %79, %c32_i256_32 : i256 loc(#loc2)
...
// CHECK-NEXT:       llvm.store %c29517451764962235613010368778373659638394623262010481748738546747006033225331_i256, %82 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c32_i256_33 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:       %83 = arith.addi %81, %c32_i256_33 : i256 loc(#loc2)
...
// CHECK-NEXT:       %84 = llvm.inttoptr %83 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c45888551966424197807937402689295079693071411769653575580334356259971920822272_i256, %84 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %85 = arith.subi %79, %75 : i256 loc(#loc2)
// CHECK-NEXT:       %c2_i256_34 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:       func.call @__revert(%75, %85, %c2_i256_34) : (i256, i256, i256) -> () loc(#loc2)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     %24 = llvm.inttoptr %7 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %25 = llvm.load %24 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:     %c31_i256 = arith.constant 31 : i256 loc(#loc2)
// CHECK-NEXT:     %26 = arith.addi %25, %c31_i256 : i256 loc(#loc2)
...
// CHECK-NEXT:     %28 = arith.addi %27, %c32_i256 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_5 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %29 = llvm.inttoptr %c64_i256_5 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %30 = llvm.load %29 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:     %31 = arith.addi %30, %28 : i256 loc(#loc2)
// CHECK-NEXT:     %c18446744073709551615_i256_6 = arith.constant 18446744073709551615 : i256 loc(#loc2)
// CHECK-NEXT:     %32 = arith.cmpi ugt, %31, %c18446744073709551615_i256_6 : i256 loc(#loc2)
// CHECK-NEXT:     %33 = arith.cmpi ult, %31, %30 : i256 loc(#loc2)
// CHECK-NEXT:     %34 = arith.ori %32, %33 : i1 loc(#loc2)
// CHECK-NEXT:     %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_7 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc2)
// CHECK-NEXT:     scf.if %34 {
// CHECK-NEXT:       %c0_i256_30 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %74 = llvm.inttoptr %c0_i256_30 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_7, %74 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %75 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %75 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     %c64_i256_8 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %35 = llvm.inttoptr %c64_i256_8 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     llvm.store %31, %35 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %36 = llvm.inttoptr %30 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     llvm.store %25, %36 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %c32_i256_9 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %37 = arith.addi %30, %c32_i256_9 : i256 loc(#loc2)
// CHECK-NEXT:     %38 = arith.addi %22, %c32_i256_9 : i256 loc(#loc2)
// CHECK-NEXT:     %39 = llvm.inttoptr %37 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %40 = llvm.inttoptr %38 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memmove"(%39, %40, %25) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c32_i256_10 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %41 = arith.addi %7, %c32_i256_10 : i256 loc(#loc2)
// CHECK-NEXT:     %42 = llvm.inttoptr %41 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %43 = llvm.load %42 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:     %44 = arith.addi %7, %43 : i256 loc(#loc2)
// CHECK-NEXT:     %c18446744073709551615_i256_11 = arith.constant 18446744073709551615 : i256 loc(#loc2)
// CHECK-NEXT:     %45 = arith.cmpi ugt, %44, %c18446744073709551615_i256_11 : i256 loc(#loc2)
...
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc2)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     %46 = llvm.inttoptr %41 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %47 = llvm.load %46 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:     %c31_i256_12 = arith.constant 31 : i256 loc(#loc2)
// CHECK-NEXT:     %48 = arith.addi %47, %c31_i256_12 : i256 loc(#loc2)
// CHECK-NEXT:     %c-32_i256_13 = arith.constant -32 : i256 loc(#loc2)
// CHECK-NEXT:     %49 = arith.andi %48, %c-32_i256_13 : i256 loc(#loc2)
// CHECK-NEXT:     %c32_i256_14 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %50 = arith.addi %49, %c32_i256_14 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_15 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %51 = llvm.inttoptr %c64_i256_15 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %52 = llvm.load %51 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc2)
// CHECK-NEXT:     %53 = arith.addi %52, %50 : i256 loc(#loc2)
// CHECK-NEXT:     %c18446744073709551615_i256_16 = arith.constant 18446744073709551615 : i256 loc(#loc2)
// CHECK-NEXT:     %54 = arith.cmpi ugt, %53, %c18446744073709551615_i256_16 : i256 loc(#loc2)
// CHECK-NEXT:     %55 = arith.cmpi ult, %53, %52 : i256 loc(#loc2)
// CHECK-NEXT:     %56 = arith.ori %54, %55 : i1 loc(#loc2)
// CHECK-NEXT:     %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_17 = arith.constant 35408467139433450592217433187231851964531694900788300625387963629091585785856 : i256 loc(#loc2)
// CHECK-NEXT:     scf.if %56 {
// CHECK-NEXT:       %c0_i256_30 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:       %74 = llvm.inttoptr %c0_i256_30 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c35408467139433450592217433187231851964531694900788300625387963629091585785856_i256_17, %74 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       %c4_i256 = arith.constant 4 : i256 loc(#loc2)
// CHECK-NEXT:       %c65_i256 = arith.constant 65 : i256 loc(#loc2)
// CHECK-NEXT:       %75 = llvm.inttoptr %c4_i256 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:       llvm.store %c65_i256, %75 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %57 = llvm.inttoptr %c64_i256_18 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     llvm.store %53, %57 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %58 = llvm.inttoptr %52 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     llvm.store %47, %58 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %c32_i256_19 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %59 = arith.addi %52, %c32_i256_19 : i256 loc(#loc2)
// CHECK-NEXT:     %60 = arith.addi %44, %c32_i256_19 : i256 loc(#loc2)
// CHECK-NEXT:     %61 = llvm.inttoptr %59 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     %62 = llvm.inttoptr %60 : i256 to !llvm.ptr<1> loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memmove"(%61, %62, %47) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c32_i256_20 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     %63 = arith.addi %41, %c32_i256_20 : i256 loc(#loc2)
// CHECK-NEXT:     call @_49(%30, %52) : (i256, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c64_i256_21 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %64 = llvm.inttoptr %c64_i256_21 : i256 to !llvm.ptr<1> loc(#loc2)
...
// CHECK-NEXT:     %69 = llvm.getelementptr %68[%c0_i256_22] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%66, %69, %c0_i256_23) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %70 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c32_i256_24 = arith.constant 32 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c32_i256_24, %70 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc2)
// CHECK-NEXT:     %71 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_25 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     llvm.store %c0_i256_25, %71 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc2)
// CHECK-NEXT:     %c0_i256_26 = arith.constant 0 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     %72 = arith.muli %c0_i256_26, %c2_i256 : i256 loc(#loc2)
// CHECK-NEXT:     %c64_i256_27 = arith.constant 64 : i256 loc(#loc2)
// CHECK-NEXT:     %73 = arith.addi %72, %c64_i256_27 : i256 loc(#loc2)
// CHECK-NEXT:     %c256_i256_28 = arith.constant 256 : i256 loc(#loc2)
// CHECK-NEXT:     %c2_i256_29 = arith.constant 2 : i256 loc(#loc2)
// CHECK-NEXT:     call @__return(%c256_i256_28, %73, %c2_i256_29) : (i256, i256, i256) -> () loc(#loc2)
