...
// CHECK-NEXT:       func.call @__revert(%c0_i256_13, %c0_i256_13, %c2_i256_14) : (i256, i256, i256) -> () loc(#loc1)
...
// CHECK-NEXT:     %5 = arith.subi %4, %c0_i256_0 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_1 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %6 = llvm.inttoptr %c64_i256_1 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:       %c0_i256_13 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:       %33 = llvm.inttoptr %c0_i256_13 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:       %c2_i256_15 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:       func.call @__revert(%c0_i256_14, %c24_i256, %c2_i256_15) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %c64_i256_2 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %12 = llvm.inttoptr %c64_i256_2 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %16 = llvm.getelementptr %15[%c0_i256_0] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%13, %16, %5) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %17 = arith.addi %7, %5 : i256 loc(#loc1)
// CHECK-NEXT:     %18 = arith.subi %17, %7 : i256 loc(#loc1)
...
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %20 = llvm.inttoptr %7 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:     %21 = llvm.load %20 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
// CHECK-NEXT:     %c32_i256_3 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     %22 = arith.addi %7, %c32_i256_3 : i256 loc(#loc1)
// CHECK-NEXT:     call @_12(%21) : (i256) -> () loc(#loc1)
// CHECK-NEXT:     %c64_i256_4 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %23 = llvm.inttoptr %c64_i256_4 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     %26 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %27 = llvm.load %26 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc1)
// CHECK-NEXT:     %28 = llvm.getelementptr %27[%c0_i256_5] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc1)
// CHECK-NEXT:     "llvm.intr.memcpy"(%25, %28, %c0_i256_6) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %c256_i256 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %29 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c32_i256_7 = arith.constant 32 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256_7, %29 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c288_i256 = arith.constant 288 : i256 loc(#loc1)
// CHECK-NEXT:     %30 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_8 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256_8, %30 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %c0_i256_9 = arith.constant 0 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     %31 = arith.muli %c0_i256_9, %c2_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %c64_i256_10 = arith.constant 64 : i256 loc(#loc1)
// CHECK-NEXT:     %32 = arith.addi %31, %c64_i256_10 : i256 loc(#loc1)
// CHECK-NEXT:     %c256_i256_11 = arith.constant 256 : i256 loc(#loc1)
// CHECK-NEXT:     %c2_i256_12 = arith.constant 2 : i256 loc(#loc1)
// CHECK-NEXT:     call @__return(%c256_i256_11, %32, %c2_i256_12) : (i256, i256, i256) -> () loc(#loc1)
