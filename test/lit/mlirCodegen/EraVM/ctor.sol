...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %3 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc1)
...
// CHECK-NEXT:     %7 = arith.addi %6, %4 : i256 loc(#loc1)
// CHECK-NEXT:     %8 = arith.cmpi ugt, %7, %c18446744073709551615_i256 : i256 loc(#loc1)
// CHECK-NEXT:     %9 = arith.cmpi ult, %7, %6 : i256 loc(#loc1)
// CHECK-NEXT:     %10 = arith.ori %8, %9 : i1 loc(#loc1)
...
// CHECK-NEXT:     llvm.store %7, %11 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     "llvm.intr.memcpy"(%12, %14, %4) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %15 = arith.cmpi slt, %4, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:     scf.if %15 {
// CHECK-NEXT:       func.call @__revert(%c0_i256, %c0_i256, %c2_i256) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:       func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     %16 = llvm.inttoptr %6 : i256 to !llvm.ptr<1> loc(#loc1)
...
// CHECK-NEXT:     "llvm.intr.memcpy"(%20, %22, %c0_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc1)
// CHECK-NEXT:     %23 = llvm.inttoptr %c256_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     llvm.store %c32_i256, %23 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     %24 = llvm.inttoptr %c288_i256 : i256 to !llvm.ptr<2> loc(#loc1)
// CHECK-NEXT:     llvm.store %c0_i256, %24 {alignment = 1 : i64} : i256, !llvm.ptr<2> loc(#loc1)
...
// CHECK-NEXT:     llvm.unreachable loc(#loc1)
// CHECK-NEXT:   } loc(#loc)
// CHECK-NEXT:   func.func @_12(%arg0: i256 loc(unknown)) attributes {kind = #Constructor, llvm.linkage = #llvm.linkage<private>, passthrough = ["nofree", "null_pointer_is_valid"], personality = @__personality, state_mutability = #NonPayable} {
