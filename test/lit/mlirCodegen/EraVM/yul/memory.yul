...
// CHECK-NEXT:     llvm.store %c1_i256, %0 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc5)
// CHECK-NEXT:     %1 = llvm.inttoptr %c1_i256 : i256 to !llvm.ptr<1> loc(#loc6)
...
// CHECK-NEXT:     %5 = llvm.inttoptr %c10_i256 : i256 to !llvm.ptr<1> loc(#loc8)
// CHECK-NEXT:     "llvm.intr.memmove"(%4, %5, %c5_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<1>, i256) -> () loc(#loc8)
