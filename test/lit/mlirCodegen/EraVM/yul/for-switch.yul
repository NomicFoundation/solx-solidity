...
// CHECK-NEXT:     llvm.store %c0_i256, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
...
// CHECK-NEXT:     cf.cond_br %2, ^bb2, ^bb4 loc(#loc7)
...
// CHECK-NEXT:     %5 = arith.addi %4, %c1_i256 : i256 loc(#loc11)
// CHECK-NEXT:     llvm.store %5, %0 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc12)
// CHECK-NEXT:     cf.br ^bb1 loc(#loc5)
