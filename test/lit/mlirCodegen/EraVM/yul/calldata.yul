...
// CHECK-NEXT:     %c0_i256_1 = arith.constant 0 : i256 loc(#loc3)
// CHECK-NEXT:     %c0_i256_2 = arith.constant 0 : i256 loc(#loc4)
...
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %5, %c0_i256_2) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc5)
...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc8)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc8)
// CHECK-NEXT:     %2 = llvm.getelementptr %1[%c0_i256_0] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc8)
// CHECK-NEXT:     %3 = llvm.load %2 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc8)
// CHECK-NEXT:     %4 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc9)
// CHECK-NEXT:     %5 = llvm.load %4 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
// CHECK-NEXT:     %6 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc10)
// CHECK-NEXT:     %7 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc10)
// CHECK-NEXT:     %8 = llvm.load %7 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc10)
// CHECK-NEXT:     %9 = llvm.getelementptr %8[%3] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc10)
// CHECK-NEXT:     "llvm.intr.memcpy"(%6, %9, %5) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc10)
// CHECK-NEXT:     llvm.unreachable loc(#loc)
// CHECK-NEXT:   } loc(#loc)
...
// CHECK-NEXT: #loc7 = loc({{.*}}:8:35)
// CHECK-NEXT: #loc8 = loc({{.*}}:8:22)
// CHECK-NEXT: #loc9 = loc({{.*}}:8:39)
