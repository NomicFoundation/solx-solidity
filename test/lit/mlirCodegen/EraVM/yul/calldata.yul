...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc2)
...
// CHECK-NEXT:     %3 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc2)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc2)
// CHECK-NEXT:     %5 = llvm.getelementptr %4[%1] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc2)
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %5, %c0_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc2)
...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %1 = llvm.load %0 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %2 = llvm.load %1 {alignment = 1 : i64} : !llvm.ptr<3> -> i256 loc(#loc4)
// CHECK-NEXT:     %3 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc5)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc5)
// CHECK-NEXT:     %5 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc6)
// CHECK-NEXT:     %6 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc6)
// CHECK-NEXT:     %7 = llvm.load %6 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc6)
// CHECK-NEXT:     %8 = llvm.getelementptr %7[%2] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc6)
// CHECK-NEXT:     "llvm.intr.memcpy"(%5, %8, %4) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc6)
// CHECK-NEXT:     llvm.unreachable loc(#loc)
// CHECK-NEXT:   } loc(#loc)
