...
// CHECK-NEXT:     %0 = llvm.mlir.addressof @calldatasize : !llvm.ptr<i256> loc(#loc1)
...
// CHECK-NEXT:     %3 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc4)
// CHECK-NEXT:     %5 = llvm.getelementptr %4[%c0_i256] : (!llvm.ptr<3>, i256) -> !llvm.ptr<3>, i8 loc(#loc4)
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %5, %c0_i256_0) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc4)
