...
// CHECK-NEXT:     %3 = llvm.mlir.addressof @ptr_calldata : !llvm.ptr<ptr<3>> loc(#loc3)
// CHECK-NEXT:     %4 = llvm.load %3 {alignment = 32 : i64} : !llvm.ptr<ptr<3>> loc(#loc3)
// CHECK-NEXT:     "llvm.intr.memcpy"(%2, %4, %c0_i256) <{isVolatile = false}> : (!llvm.ptr<1>, !llvm.ptr<3>, i256) -> () loc(#loc3)
