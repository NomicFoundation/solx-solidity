...
// CHECK-NEXT:     llvm.store %3, %4 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %5 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     llvm.store %c1_i256, %5 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %6 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %7 = call @__sha3(%6, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc3)
...
// CHECK-NEXT:     llvm.store %8, %9 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %10 = llvm.inttoptr %c32_i256 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     llvm.store %7, %10 {alignment = 1 : i64} : i256, !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %11 = llvm.inttoptr %c0_i256 : i256 to !llvm.ptr<1> loc(#loc3)
// CHECK-NEXT:     %12 = call @__sha3(%11, %c64_i256, %false) : (!llvm.ptr<1>, i256, i1) -> i256 loc(#loc3)
// CHECK-NEXT:     %13 = llvm.load %2 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc9)
// CHECK-NEXT:     %14 = llvm.inttoptr %12 : i256 to !llvm.ptr<5> loc(#loc3)
// CHECK-NEXT:     llvm.store %13, %14 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc3)
...
// CHECK-NEXT:     %c0_i256 = arith.constant 0 : i256 loc(#loc11)
...
// CHECK-NEXT:     llvm.store %1, %2 {alignment = 1 : i64} : i256, !llvm.ptr<5> loc(#loc14)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:7:59)
// CHECK-NEXT: #loc4 = loc({{.*}}:7:16)
// CHECK-NEXT: #loc5 = loc({{.*}}:7:27)
// CHECK-NEXT: #loc6 = loc({{.*}}:7:38)
...
// CHECK-NEXT: #loc13 = loc({{.*}}:6:39)
// CHECK-NEXT: #loc14 = loc({{.*}}:6:34)
// CHECK-EMPTY:
