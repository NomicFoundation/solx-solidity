...
// CHECK-NEXT:         %18 = func.call @ui64_20(%17) : (i64) -> i64 loc(#loc1)
...
// CHECK-NEXT:         %21 = arith.extui %18 : i64 to i256 loc(#loc1)
...
// CHECK-NEXT:         func.call @__return(%20, %c32_i256, %c0_i256) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
// CHECK-NEXT:         scf.yield loc(#loc1)
// CHECK-NEXT:       }
...
// CHECK-NEXT:         %18 = func.call @i1_10(%17) : (i1) -> i1 loc(#loc1)
// CHECK-NEXT:         %19 = llvm.inttoptr %c64_i256 : i256 to !llvm.ptr<1> loc(#loc1)
// CHECK-NEXT:         %20 = llvm.load %19 {alignment = 1 : i64} : !llvm.ptr<1> -> i256 loc(#loc1)
