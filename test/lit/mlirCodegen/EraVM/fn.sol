...
// CHECK-NEXT:         %21 = llvm.getelementptr %20[4] : (!llvm.ptr<3>) -> !llvm.ptr<3>, i8 loc(#loc1)
...
// CHECK-NEXT:         %34 = arith.addi %27, %c32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %35 = arith.addi %16, %c36_i256 : i256 loc(#loc1)
...
// CHECK-NEXT:         %40 = func.call @str_54(%27) : (i256) -> i256 loc(#loc1)
...
// CHECK-NEXT:         %52 = arith.addi %49, %46 : i256 loc(#loc1)
...
// CHECK-NEXT:         %54 = arith.addi %46, %c31_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %55 = arith.andi %54, %c-32_i256 : i256 loc(#loc1)
// CHECK-NEXT:         %56 = arith.addi %49, %55 : i256 loc(#loc1)
// CHECK-NEXT:         %57 = arith.subi %56, %42 : i256 loc(#loc1)
// CHECK-NEXT:         func.call @__return(%42, %57, %c0_i256) : (i256, i256, i256) -> () loc(#loc1)
// CHECK-NEXT:         func.call @".unreachable"() : () -> () loc(#loc1)
