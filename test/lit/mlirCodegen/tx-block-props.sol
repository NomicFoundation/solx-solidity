...
// CHECK-NEXT: #loc48 = loc({{.*}}:18:24)
// CHECK-NEXT: #loc53 = loc({{.*}}:19:23)
...
// CHECK-NEXT:       %1 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc49)
// CHECK-NEXT:       %2 = sol.blockhash %1 : <32> loc(#loc50)
// CHECK-NEXT:       sol.return %2 : !sol.fixedbytes<32> loc(#loc51)
...
// CHECK-NEXT:       %0 = sol.alloca : !sol.ptr<ui256, Stack> loc(#loc53)
// CHECK-NEXT:       sol.store %arg0, %0 : ui256, !sol.ptr<ui256, Stack> loc(#loc53)
// CHECK-NEXT:       %1 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc54)
// CHECK-NEXT:       %2 = sol.blobhash %1 : <32> loc(#loc55)
// CHECK-NEXT:       sol.return %2 : !sol.fixedbytes<32> loc(#loc56)
...
// CHECK-NEXT: #loc47 = loc({{.*}}:18:4)
// CHECK-NEXT: #loc49 = loc({{.*}}:18:81)
// CHECK-NEXT: #loc50 = loc({{.*}}:18:71)
// CHECK-NEXT: #loc51 = loc({{.*}}:18:64)
// CHECK-NEXT: #loc52 = loc({{.*}}:19:4)
// CHECK-NEXT: #loc54 = loc({{.*}}:19:79)
// CHECK-NEXT: #loc55 = loc({{.*}}:19:70)
// CHECK-NEXT: #loc56 = loc({{.*}}:19:63)
// CHECK-EMPTY:
