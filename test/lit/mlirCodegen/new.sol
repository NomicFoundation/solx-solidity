...
// CHECK-NEXT:       %2 = yul.gas loc(#loc3)
// CHECK-NEXT:       %3 = sol.conv_cast %2 : i256 -> ui256 loc(#loc3)
// CHECK-NEXT:       %c0_ui256_0 = sol.constant 0 : ui256 loc(#loc3)
// CHECK-NEXT:       %status, %4 = sol.ext_call "f_8"() at %1 gas %3 value %c0_ui256_0 {callee_type = () -> ui256, selector = 638722032 : i32} : !sol.address, () -> (i1, ui256) loc(#loc3)
// CHECK-NEXT:       sol.return %4 : ui256 loc(#loc4)
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:   } {kind = #Contract} loc(#loc1)
// CHECK-NEXT: } loc(#loc)
// CHECK-NEXT: #loc = loc(unknown)
