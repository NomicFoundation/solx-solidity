...
// CHECK-NEXT:       sol.placeholder loc(#loc11)
...
// CHECK-NEXT:       sol.call @f_30(%1) : (ui256) -> () loc(#loc16)
...
// CHECK-NEXT: #loc6 = loc({{.*}}:5:26)
// CHECK-NEXT: #loc7 = loc({{.*}}:5:28)
// CHECK-NEXT: #loc8 = loc({{.*}}:5:32)
// CHECK-NEXT: #loc9 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc11 = loc({{.*}}:3:23)
// CHECK-NEXT: #loc12 = loc({{.*}}:4:2)
// CHECK-NEXT: #loc14 = loc({{.*}}:4:23)
// CHECK-NEXT: #loc15 = loc({{.*}}:4:28)
// CHECK-NEXT: #loc16 = loc({{.*}}:4:26)
// CHECK-EMPTY:
