...
// CHECK-NEXT:       %1 = sol.call @g_8() : () -> ui256 loc(#loc4)
...
// CHECK-NEXT: #loc3 = loc({{.*}}:11:50)
// CHECK-NEXT: #loc4 = loc({{.*}}:11:65)
// CHECK-NEXT: #loc5 = loc({{.*}}:11:58)
// CHECK-NEXT: #loc6 = loc({{.*}}:3:2)
// CHECK-NEXT: #loc7 = loc({{.*}}:3:33)
// CHECK-NEXT: #loc8 = loc({{.*}}:3:48)
