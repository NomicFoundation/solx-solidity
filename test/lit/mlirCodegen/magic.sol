...
// CHECK-NEXT:     %0 = sol.alloca : !sol.ptr<!sol.fixedbytes<4>, Stack> loc(#loc92)
// CHECK-NEXT:     sol.store %arg0, %0 : !sol.fixedbytes<4>, !sol.ptr<!sol.fixedbytes<4>, Stack> loc(#loc92)
// CHECK-NEXT:     %1 = sol.alloca : !sol.ptr<ui256, Stack> loc(#loc93)
// CHECK-NEXT:     sol.store %arg1, %1 : ui256, !sol.ptr<ui256, Stack> loc(#loc93)
// CHECK-NEXT:     %2 = sol.load %0 : !sol.ptr<!sol.fixedbytes<4>, Stack>, !sol.fixedbytes<4> loc(#loc94)
// CHECK-NEXT:     %3 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc95)
// CHECK-NEXT:     %4 = sol.encode selector(%2) %3 : !sol.fixedbytes<4> ui256 : !sol.string<Memory> loc(#loc96)
...
// CHECK-NEXT:     %0 = sol.bytes_cast %c69443890_ui32 : ui32 to !sol.fixedbytes<4> loc(#loc99)
// CHECK-NEXT:     %1 = sol.encode selector(%0) : !sol.fixedbytes<4>  : !sol.string<Memory> loc(#loc99)
...
// CHECK-NEXT:     %2 = "sol.keccak256"(%1) : (!sol.string<Memory>) -> !sol.fixedbytes<32> loc(#loc104)
// CHECK-NEXT:     %3 = sol.bytes_cast %2 : !sol.fixedbytes<32> to !sol.fixedbytes<4> loc(#loc104)
// CHECK-NEXT:     %4 = sol.encode selector(%3) : !sol.fixedbytes<4>  : !sol.string<Memory> loc(#loc104)
...
// CHECK-NEXT:     %3 = "sol.keccak256"(%2) : (!sol.string<Memory>) -> !sol.fixedbytes<32> loc(#loc109)
// CHECK-NEXT:     %4 = sol.bytes_cast %3 : !sol.fixedbytes<32> to !sol.fixedbytes<4> loc(#loc109)
// CHECK-NEXT:     %5 = sol.encode selector(%4) : !sol.fixedbytes<4>  : !sol.string<Memory> loc(#loc109)
...
// CHECK-NEXT:     %1 = sol.bytes_cast %c801029432_ui32 : ui32 to !sol.fixedbytes<4> loc(#loc113)
// CHECK-NEXT:     %2 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc114)
// CHECK-NEXT:     %3 = sol.encode selector(%1) %2 : !sol.fixedbytes<4> ui256 : !sol.string<Memory> loc(#loc113)
...
// CHECK-NEXT:     %2 = sol.bytes_cast %c105187873_ui32 : ui32 to !sol.fixedbytes<4> loc(#loc119)
// CHECK-NEXT:     %3 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc120)
// CHECK-NEXT:     %4 = sol.load %1 : !sol.ptr<ui8, Stack>, ui8 loc(#loc121)
// CHECK-NEXT:     %5 = sol.encode selector(%2) %3, %4 : !sol.fixedbytes<4> ui256, ui8 : !sol.string<Memory> loc(#loc119)
...
// CHECK-NEXT:       %0 = sol.alloca : !sol.ptr<!sol.fixedbytes<4>, Stack> loc(#loc158)
// CHECK-NEXT:       sol.store %arg0, %0 : !sol.fixedbytes<4>, !sol.ptr<!sol.fixedbytes<4>, Stack> loc(#loc158)
...
// CHECK-NEXT:       %4 = sol.load %0 : !sol.ptr<!sol.fixedbytes<4>, Stack>, !sol.fixedbytes<4> loc(#loc162)
// CHECK-NEXT:       %5 = sol.addr_of @str_440 : !sol.string<Storage> loc(#loc139)
// CHECK-NEXT:       %6 = sol.encode selector(%4) %5 : !sol.fixedbytes<4> !sol.string<Storage> : !sol.string<Memory> loc(#loc163)
...
// CHECK-NEXT:       %6 = "sol.keccak256"(%5) : (!sol.string<Memory>) -> !sol.fixedbytes<32> loc(#loc170)
// CHECK-NEXT:       %7 = sol.bytes_cast %6 : !sol.fixedbytes<32> to !sol.fixedbytes<4> loc(#loc170)
// CHECK-NEXT:       %8 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc171)
// CHECK-NEXT:       %9 = sol.encode selector(%7) %8 : !sol.fixedbytes<4> ui256 : !sol.string<Memory> loc(#loc170)
