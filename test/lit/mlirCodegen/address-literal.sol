...
// CHECK-NEXT:       %c255_ui160 = sol.constant 255 : ui160 loc(#loc4)
// CHECK-NEXT:       %2 = sol.address_cast %c255_ui160 : ui160 to !sol.address loc(#loc4)
...
// CHECK-NEXT:       %c255_ui160 = sol.constant 255 : ui160 loc(#loc8)
// CHECK-NEXT:       %2 = sol.address_cast %c255_ui160 : ui160 to !sol.address loc(#loc8)
// CHECK-NEXT:       %3 = sol.alloca : !sol.ptr<!sol.address, Stack> loc(#loc9)
// CHECK-NEXT:       sol.store %2, %3 : !sol.address, !sol.ptr<!sol.address, Stack> loc(#loc9)
// CHECK-NEXT:       %4 = sol.load %3 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc10)
...
// CHECK-NEXT: #loc7 = loc({{.*}}:7:46)
// CHECK-NEXT: #loc8 = loc({{.*}}:8:20)
