...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     sol.func @defInit_11() -> ui256 attributes {id = 11 : i64, orig_fn_type = () -> ui256, selector = -584775204 : i32, state_mutability = #View} {
...
// CHECK-NEXT:     } loc(#loc2)
// CHECK-NEXT:     sol.func @init_23() -> ui256 attributes {id = 23 : i64, orig_fn_type = () -> ui256, selector = -507037398 : i32, state_mutability = #View} {
...
// CHECK-NEXT:       %2 = sol.cast %c42_ui8 : ui8 to ui256 loc(#loc9)
// CHECK-NEXT:       sol.store %2, %1 : ui256, !sol.ptr<ui256, Stack> loc(#loc10)
