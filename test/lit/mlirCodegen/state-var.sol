...
// CHECK-NEXT:     sol.state_var @s_14 slot 3 offset 0 : !sol.string<Storage> loc(#loc5)
// CHECK-NEXT:     sol.func @C_69() attributes {kind = #Constructor, orig_fn_type = () -> (), state_mutability = #NonPayable} {
// CHECK-NEXT:       sol.return loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     sol.func @get_ui_22() -> ui256 attributes {id = 22 : i64, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     } loc(#loc6)
// CHECK-NEXT:     sol.func @get_m0_34(%arg0: !sol.address loc({{.*}}:9:18)) -> ui256 attributes {id = 34 : i64, state_mutability = #NonPayable} {
// CHECK-NEXT:       %0 = sol.alloca : !sol.ptr<!sol.address, Stack> loc(#loc10)
// CHECK-NEXT:       sol.store %arg0, %0 : !sol.address, !sol.ptr<!sol.address, Stack> loc(#loc10)
// CHECK-NEXT:       %1 = sol.addr_of @m0_6 : !sol.mapping<!sol.address, ui256> loc(#loc3)
// CHECK-NEXT:       %2 = sol.load %0 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc11)
// CHECK-NEXT:       %3 = sol.map %1, %2 : !sol.mapping<!sol.address, ui256>, !sol.address, !sol.ptr<ui256, Storage> loc(#loc12)
// CHECK-NEXT:       %4 = sol.load %3 : !sol.ptr<ui256, Storage>, ui256 loc(#loc12)
// CHECK-NEXT:       sol.return %4 : ui256 loc(#loc13)
// CHECK-NEXT:     } loc(#loc9)
// CHECK-NEXT:     sol.func @get_m1_50(%arg0: !sol.address loc({{.*}}:10:18), %arg1: !sol.address loc({{.*}}:10:29)) -> ui256 attributes {id = 50 : i64, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %3 = sol.load %0 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc17)
// CHECK-NEXT:       %4 = sol.map %2, %3 : !sol.mapping<!sol.address, !sol.mapping<!sol.address, ui256>>, !sol.address, !sol.mapping<!sol.address, ui256> loc(#loc18)
// CHECK-NEXT:       %5 = sol.load %1 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc19)
// CHECK-NEXT:       %6 = sol.map %4, %5 : !sol.mapping<!sol.address, ui256>, !sol.address, !sol.ptr<ui256, Storage> loc(#loc18)
// CHECK-NEXT:       %7 = sol.load %6 : !sol.ptr<ui256, Storage>, ui256 loc(#loc18)
// CHECK-NEXT:       sol.return %7 : ui256 loc(#loc20)
// CHECK-NEXT:     } loc(#loc14)
// CHECK-NEXT:     sol.func @get_s_58() -> !sol.string<Memory> attributes {id = 58 : i64, state_mutability = #NonPayable} {
// CHECK-NEXT:       %0 = sol.addr_of @s_14 : !sol.string<Storage> loc(#loc5)
...
// CHECK-NEXT:     sol.func @set_s_68(%arg0: !sol.string<Memory> loc({{.*}}:13:17)) attributes {id = 68 : i64, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %1 = sol.addr_of @s_14 : !sol.string<Storage> loc(#loc5)
