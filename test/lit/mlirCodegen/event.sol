...
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     sol.func @f_24(%arg0: !sol.address loc({{.*}}:4:13), %arg1: !sol.address loc({{.*}}:4:24), %arg2: ui256 loc({{.*}}:4:35)) attributes {id = 24 : i64, orig_fn_type = (!sol.address, !sol.address, ui256) -> (), selector = -1790387060 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       sol.store %arg1, %1 : !sol.address, !sol.ptr<!sol.address, Stack> loc(#loc4)
// CHECK-NEXT:       %2 = sol.alloca : !sol.ptr<ui256, Stack> loc(#loc5)
// CHECK-NEXT:       sol.store %arg2, %2 : ui256, !sol.ptr<ui256, Stack> loc(#loc5)
// CHECK-NEXT:       %3 = sol.load %0 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc6)
// CHECK-NEXT:       %4 = sol.load %1 : !sol.ptr<!sol.address, Stack>, !sol.address loc(#loc7)
// CHECK-NEXT:       %5 = sol.load %2 : !sol.ptr<ui256, Stack>, ui256 loc(#loc8)
// CHECK-NEXT:       sol.emit "E(address,address,uint256)" indexed = [%3, %4] non_indexed = [%5] : !sol.address, !sol.address, ui256 loc(#loc9)
