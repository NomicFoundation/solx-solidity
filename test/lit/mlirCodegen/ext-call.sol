...
// CHECK-NEXT:       %status, %5 = sol.ext_call "f_23"(%2) at %1 gas %4 value %c0_ui256 {callee_type = (ui256) -> ui256, selector = -1277270901 : i32} : !sol.address, (ui256) -> (i1, ui256) loc(#loc4)
...
// CHECK-NEXT:       %8 = sol.this : !sol.address loc(#loc9)
// CHECK-NEXT:       %9 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc10)
// CHECK-NEXT:       %10 = sol.conv_cast %7 : ui256 -> ui256 loc(#loc9)
// CHECK-NEXT:       %status_0, %11 = sol.ext_call "f_23"(%9) at %8 gas %10 value %6 {callee_type = (ui256) -> ui256, selector = -1277270901 : i32} : !sol.address, (ui256) -> (i1, ui256) loc(#loc9)
