...
// CHECK-NEXT:     %0 = sol.mload %c64_i256 loc(#loc2)
// CHECK-NEXT:     %c1_i256 = arith.constant 1 : i256 loc(#loc3)
// CHECK-NEXT:     %1 = llvm.alloca %c1_i256 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc4)
// CHECK-NEXT:     llvm.store %0, %1 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc3)
...
// CHECK-NEXT:       %3 = sol.mload %c64_i256_0 loc(#loc9)
// CHECK-NEXT:       %c1_i256_1 = arith.constant 1 : i256 loc(#loc10)
// CHECK-NEXT:       %4 = llvm.alloca %c1_i256_1 x i256 {alignment = 32 : i64} : (i256) -> !llvm.ptr<i256> loc(#loc11)
// CHECK-NEXT:       llvm.store %3, %4 {alignment = 32 : i64} : !llvm.ptr<i256> loc(#loc10)
