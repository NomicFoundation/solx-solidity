...
// CHECK-NEXT:     sol.func @C_12() attributes {kind = #Constructor, orig_fn_type = () -> (), state_mutability = #NonPayable} {
// CHECK-NEXT:       sol.return loc(#loc1)
// CHECK-NEXT:     } loc(#loc1)
// CHECK-NEXT:     sol.func @g_11(%arg0: !sol.string<CallData> loc({{.*}}:3:13)) -> ui256 attributes {id = 11 : i64, orig_fn_type = (!sol.string<CallData>) -> ui256, selector = -1061649387 : i32, state_mutability = #Pure} {
...
// CHECK-NEXT:       %2 = sol.load %0 : !sol.ptr<!sol.string<CallData>, Stack>, !sol.string<CallData> loc(#loc5)
// CHECK-NEXT:       %3 = sol.length %2 : !sol.string<CallData> loc(#loc5)
