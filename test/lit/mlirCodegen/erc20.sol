...
// CHECK-NEXT:     sol.func @balanceOf_102(%arg0: ui256 loc({{.*}}:41:21)) -> ui256 attributes {id = 102 : i64, orig_fn_type = (ui256) -> ui256, selector = 1889567281 : i32, state_mutability = #View} {
...
// CHECK-NEXT:     sol.func @transfer_121(%arg0: ui256 loc({{.*}}:45:20), %arg1: ui256 loc({{.*}}:45:39)) -> i1 attributes {id = 121 : i64, orig_fn_type = (ui256, ui256) -> i1, selector = -1459249989 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     sol.func @allowance_137(%arg0: ui256 loc({{.*}}:50:21), %arg1: ui256 loc({{.*}}:50:36)) -> ui256 attributes {id = 137 : i64, orig_fn_type = (ui256, ui256) -> ui256, selector = -580719298 : i32, state_mutability = #View} {
...
// CHECK-NEXT:       %2 = sol.addr_of @_allowances_11 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>> loc(#loc3)
...
// CHECK-NEXT:     sol.func @approve_156(%arg0: ui256 loc({{.*}}:54:19), %arg1: ui256 loc({{.*}}:54:36)) -> i1 attributes {id = 156 : i64, orig_fn_type = (ui256, ui256) -> i1, selector = 157198259 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:     sol.func @transferFrom_202(%arg0: ui256 loc({{.*}}:59:24), %arg1: ui256 loc({{.*}}:59:40), %arg2: ui256 loc({{.*}}:59:59)) -> i1 attributes {id = 202 : i64, orig_fn_type = (ui256, ui256, ui256) -> i1, selector = 599290589 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %6 = sol.addr_of @_allowances_11 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>> loc(#loc3)
// CHECK-NEXT:       %7 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc65)
// CHECK-NEXT:       %8 = sol.map %6, %7 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>>, ui256, !sol.mapping<ui256, ui256> loc(#loc66)
// CHECK-NEXT:       %9 = sol.call @_msgSender_58() : () -> ui256 loc(#loc67)
// CHECK-NEXT:       %10 = sol.map %8, %9 : !sol.mapping<ui256, ui256>, ui256, !sol.ptr<ui256, Storage> loc(#loc66)
...
// CHECK-NEXT:     sol.func @increaseAllowance_229(%arg0: ui256 loc({{.*}}:74:29), %arg1: ui256 loc({{.*}}:74:46)) -> i1 attributes {id = 229 : i64, orig_fn_type = (ui256, ui256) -> i1, selector = 961581905 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %4 = sol.addr_of @_allowances_11 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>> loc(#loc3)
...
// CHECK-NEXT:     sol.func @decreaseAllowance_267(%arg0: ui256 loc({{.*}}:83:29), %arg1: ui256 loc({{.*}}:83:46)) -> i1 attributes {id = 267 : i64, orig_fn_type = (ui256, ui256) -> i1, selector = -1537752361 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %2 = sol.addr_of @_allowances_11 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>> loc(#loc3)
// CHECK-NEXT:       %3 = sol.call @_msgSender_58() : () -> ui256 loc(#loc94)
// CHECK-NEXT:       %4 = sol.map %2, %3 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>>, ui256, !sol.mapping<ui256, ui256> loc(#loc95)
// CHECK-NEXT:       %5 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc96)
// CHECK-NEXT:       %6 = sol.map %4, %5 : !sol.mapping<ui256, ui256>, ui256, !sol.ptr<ui256, Storage> loc(#loc95)
...
// CHECK-NEXT:     sol.func @_transfer_332(%arg0: ui256 loc({{.*}}:96:21), %arg1: ui256 loc({{.*}}:96:37), %arg2: ui256 loc({{.*}}:96:56)) attributes {id = 332 : i64, orig_fn_type = (ui256, ui256, ui256) -> (), selector = 820017310 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %4 = sol.cast %c0_ui8 : ui8 to ui256 loc(#loc113)
...
// CHECK-NEXT:       %7 = sol.cast %c0_ui8_0 : ui8 to ui256 loc(#loc116)
// CHECK-NEXT:       %8 = sol.cmp ne, %6, %7 : ui256 loc(#loc115)
// CHECK-NEXT:       sol.require %8, "ERC20: transfer to the zero address"() loc(#loc117)
// CHECK-NEXT:       %9 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
// CHECK-NEXT:       %10 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc118)
// CHECK-NEXT:       %11 = sol.map %9, %10 : !sol.mapping<ui256, ui256>, ui256, !sol.ptr<ui256, Storage> loc(#loc119)
// CHECK-NEXT:       %12 = sol.load %11 : !sol.ptr<ui256, Storage>, ui256 loc(#loc119)
// CHECK-NEXT:       %13 = sol.alloca : !sol.ptr<ui256, Stack> loc(#loc120)
// CHECK-NEXT:       sol.store %12, %13 : ui256, !sol.ptr<ui256, Stack> loc(#loc120)
// CHECK-NEXT:       %14 = sol.load %13 : !sol.ptr<ui256, Stack>, ui256 loc(#loc121)
...
// CHECK-NEXT:       %17 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
...
// CHECK-NEXT:       %20 = sol.load %13 : !sol.ptr<ui256, Stack>, ui256 loc(#loc126)
...
// CHECK-NEXT:       %23 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
...
// CHECK-NEXT:       %27 = sol.load %25 : !sol.ptr<ui256, Storage>, ui256 loc(#loc129)
// CHECK-NEXT:       %28 = sol.add %27, %26 : ui256 loc(#loc129)
// CHECK-NEXT:       sol.store %28, %25 : ui256, !sol.ptr<ui256, Storage> loc(#loc129)
// CHECK-NEXT:       %29 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc131)
// CHECK-NEXT:       %30 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc132)
// CHECK-NEXT:       %31 = sol.load %2 : !sol.ptr<ui256, Stack>, ui256 loc(#loc133)
...
// CHECK-NEXT:     sol.func @_mint_370(%arg0: ui256 loc({{.*}}:114:17), %arg1: ui256 loc({{.*}}:114:34)) attributes {id = 370 : i64, orig_fn_type = (ui256, ui256) -> (), selector = 1315881543 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %3 = sol.cast %c0_ui8 : ui8 to ui256 loc(#loc139)
// CHECK-NEXT:       %4 = sol.cmp ne, %2, %3 : ui256 loc(#loc138)
// CHECK-NEXT:       sol.require %4, "ERC20: mint to the zero address"() loc(#loc140)
// CHECK-NEXT:       %5 = sol.addr_of @_totalSupply_13 : !sol.ptr<ui256, Storage> loc(#loc4)
// CHECK-NEXT:       %6 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc141)
// CHECK-NEXT:       %7 = sol.load %5 : !sol.ptr<ui256, Storage>, ui256 loc(#loc142)
// CHECK-NEXT:       %8 = sol.add %7, %6 : ui256 loc(#loc142)
// CHECK-NEXT:       sol.store %8, %5 : ui256, !sol.ptr<ui256, Storage> loc(#loc142)
// CHECK-NEXT:       %9 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
// CHECK-NEXT:       %10 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc143)
// CHECK-NEXT:       %11 = sol.map %9, %10 : !sol.mapping<ui256, ui256>, ui256, !sol.ptr<ui256, Storage> loc(#loc144)
// CHECK-NEXT:       %12 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc145)
// CHECK-NEXT:       %13 = sol.load %11 : !sol.ptr<ui256, Storage>, ui256 loc(#loc144)
// CHECK-NEXT:       %14 = sol.add %13, %12 : ui256 loc(#loc144)
// CHECK-NEXT:       sol.store %14, %11 : ui256, !sol.ptr<ui256, Storage> loc(#loc144)
// CHECK-NEXT:       %c0_ui8_0 = sol.constant 0 : ui8 loc(#loc146)
// CHECK-NEXT:       %15 = sol.cast %c0_ui8_0 : ui8 to ui256 loc(#loc146)
// CHECK-NEXT:       %16 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc147)
// CHECK-NEXT:       %17 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc148)
...
// CHECK-NEXT:     sol.func @_burn_424(%arg0: ui256 loc({{.*}}:124:17), %arg1: ui256 loc({{.*}}:124:34)) attributes {id = 424 : i64, orig_fn_type = (ui256, ui256) -> (), selector = 1633807128 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %3 = sol.cast %c0_ui8 : ui8 to ui256 loc(#loc154)
// CHECK-NEXT:       %4 = sol.cmp ne, %2, %3 : ui256 loc(#loc153)
// CHECK-NEXT:       sol.require %4, "ERC20: burn from the zero address"() loc(#loc155)
// CHECK-NEXT:       %5 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
// CHECK-NEXT:       %6 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc156)
// CHECK-NEXT:       %7 = sol.map %5, %6 : !sol.mapping<ui256, ui256>, ui256, !sol.ptr<ui256, Storage> loc(#loc157)
// CHECK-NEXT:       %8 = sol.load %7 : !sol.ptr<ui256, Storage>, ui256 loc(#loc157)
// CHECK-NEXT:       %9 = sol.alloca : !sol.ptr<ui256, Stack> loc(#loc158)
// CHECK-NEXT:       sol.store %8, %9 : ui256, !sol.ptr<ui256, Stack> loc(#loc158)
// CHECK-NEXT:       %10 = sol.load %9 : !sol.ptr<ui256, Stack>, ui256 loc(#loc159)
...
// CHECK-NEXT:       %13 = sol.addr_of @_balances_5 : !sol.mapping<ui256, ui256> loc(#loc2)
...
// CHECK-NEXT:       %16 = sol.load %9 : !sol.ptr<ui256, Stack>, ui256 loc(#loc164)
...
// CHECK-NEXT:       %19 = sol.addr_of @_totalSupply_13 : !sol.ptr<ui256, Storage> loc(#loc4)
// CHECK-NEXT:       %20 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc166)
// CHECK-NEXT:       %21 = sol.load %19 : !sol.ptr<ui256, Storage>, ui256 loc(#loc167)
// CHECK-NEXT:       %22 = sol.sub %21, %20 : ui256 loc(#loc167)
// CHECK-NEXT:       sol.store %22, %19 : ui256, !sol.ptr<ui256, Storage> loc(#loc167)
// CHECK-NEXT:       %23 = sol.load %0 : !sol.ptr<ui256, Stack>, ui256 loc(#loc168)
// CHECK-NEXT:       %c0_ui8_0 = sol.constant 0 : ui8 loc(#loc169)
// CHECK-NEXT:       %24 = sol.cast %c0_ui8_0 : ui8 to ui256 loc(#loc169)
// CHECK-NEXT:       %25 = sol.load %1 : !sol.ptr<ui256, Stack>, ui256 loc(#loc170)
...
// CHECK-NEXT:     sol.func @_approve_469(%arg0: ui256 loc({{.*}}:142:20), %arg1: ui256 loc({{.*}}:142:35), %arg2: ui256 loc({{.*}}:142:52)) attributes {id = 469 : i64, orig_fn_type = (ui256, ui256, ui256) -> (), selector = 273580543 : i32, state_mutability = #NonPayable} {
...
// CHECK-NEXT:       %4 = sol.cast %c0_ui8 : ui8 to ui256 loc(#loc177)
...
// CHECK-NEXT:       %7 = sol.cast %c0_ui8_0 : ui8 to ui256 loc(#loc180)
// CHECK-NEXT:       %8 = sol.cmp ne, %6, %7 : ui256 loc(#loc179)
// CHECK-NEXT:       sol.require %8, "ERC20: approve to the zero address"() loc(#loc181)
// CHECK-NEXT:       %9 = sol.addr_of @_allowances_11 : !sol.mapping<ui256, !sol.mapping<ui256, ui256>> loc(#loc3)
