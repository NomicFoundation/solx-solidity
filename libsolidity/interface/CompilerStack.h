...
public:
	...
	/// @returns the creation bytecode generated by the mlir pipeline.
	std::string const& creationBytecodeFromMlirPipeline(std::string const& _contractName) const;

	/// @returns the runtime bytecode generated by the mlir pipeline.
	std::string const& runtimeBytecodeFromMlirPipeline(std::string const& _contractName) const;
