...
std::variant<OptimiserSettings, Json>
parseOptimizerSettings(std::string_view const _language, Json const& _jsonInput, mlirgen::JobSpec& mlirJobSpec)
{
...
std::variant<StandardCompiler::InputsAndSettings, Json> StandardCompiler::parseInput(Json const& _input)
{
	...
	{
		auto optimiserSettings = parseOptimizerSettings(ret.language, settings["optimizer"], ret.mlirJobSpec);
